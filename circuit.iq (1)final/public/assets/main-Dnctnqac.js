...
<div class="page">
  ...
  <div class="footer">
    Generated by Circuit IQ Virtual Laboratory · ${n} · Experiment: ${t.name}
        ...
        The exponential charging curve V_C(t) = V_s(1−e^(−t/τ)) is visible on the oscilloscope.`}else X.conclusionText.innerText=`Recorded ${Y.dataPoints.length}/5 points. Adjust voltage and record more points to complete the experiment.`;Cp(),Bp(),ah()}),document.querySelectorAll(`.comp-chip`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-type`);if(t===`bb_half`){mm(`half`),document.querySelectorAll(`[data-type="bb_half"], [data-type="bb_full"]`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`);return}if(t===`bb_full`){mm(`full`),document.querySelectorAll(`[data-type="bb_half"], [data-type="bb_full"]`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`);return}Y.selectedComponentIdx=-1,Y.selectedHoleIndex=null,Nm(!0),Jm(),document.querySelectorAll(`.comp-chip:not([data-type^="bb_"])`).forEach(e=>e.classList.remove(`selected`));let n=t;(t===`led_red`||t===`led_green`)&&(n=`led`),Y.selectedTool===n?(Y.selectedTool=null,op(`Circuit IQ · AI Mentor`,`Tool deselected.`)):(Y.selectedTool=n,e.classList.add(`selected`),op(`Circuit IQ · AI Mentor`,`Selected ${n.toUpperCase()}. Click on two board snap points to place it.`)),Y.placementStartHole=null,Y.wiringStart=null,wp(),Rp()})}),document.querySelectorAll(`.comp-chip[draggable="true"]`).forEach(e=>{e.addEventListener(`dragstart`,t=>{let n=e.getAttribute(`data-type`),r=n;(n===`led_red`||n===`led_green`)&&(r=`led`),Y.draggingSidebarTool=r,t.dataTransfer.setData(`text/plain`,r),t.dataTransfer.effectAllowed=`move`,document.querySelectorAll(`.comp-chip:not([data-type^="bb_"])`).forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`)}),e.addEventListener(`dragend`,e=>{Y.draggingSidebarTool=null,Y.ghostMesh&&=(Z.remove(Y.ghostMesh),null),Y.ghostSnap1=null,Y.ghostSnap2=null,document.querySelectorAll(`.comp-chip:not([data-type^="bb_"])`).forEach(e=>e.classList.remove(`selected`)),Y.selectedTool=null,wp()})}),document.querySelectorAll(`.component-value-select`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation()}),e.addEventListener(`change`,t=>{let n=e.getAttribute(`data-param`);if(n)if(n===`led_color`)cp(e.value);else{let t=parseFloat(e.value);isNaN(t)||sp(n,t)}})});let t=document.getElementById(`components-search`),n=document.getElementById(`search-clear`);t&&(t.addEventListener(`input`,()=>{mp()}),t.addEventListener(`keydown`,e=>{e.key===`Escape`&&(t.value=``,mp())})),n&&t&&n.addEventListener(`click`,()=>{t.value=``,mp(),t.focus()}),X.btnClear.addEventListener(`click`,()=>{pp(Y.activeExperiment,!1),wp(),rh()}),X.btnRun.addEventListener(`click`,async()=>{await Mp(),Bp()}),X.btnStop.addEventListener(`click`,()=>{Y.isRunning=!1,np(),Yf(!1),X.btnRun.style.display=`block`,X.btnStop.style.display=`none`,X.statusDot.style.background=`var(--accent)`,X.statusTextBar.innerText=`READY`,op(`Circuit IQ · AI Mentor`,`Power supply terminated.`),Tm(),Bp()}),X.btnReload.addEventListener(`click`,()=>{Np(),op(`Circuit IQ · AI Mentor`,`Auto-build complete! Circuit components and wires placed correctly.`)}),X.btnCloseLab&&X.btnCloseLab.addEventListener(`click`,()=>{window.parent.postMessage(`close-lab`,`*`)});let r=(e,t,n)=>{e.addEventListener(`input`,e=>{let t=parseFloat(e.target.value);isNaN(t)||sp(n,t)}),t&&(t.addEventListener(`input`,e=>{let t=parseFloat(e.target.value);isNaN(t)||sp(n,t)}),t.addEventListener(`blur`,e=>{let r=parseFloat(e.target.value);isNaN(r)?t.value=Y.params[n]:sp(n,r)}))};r(X.sliderV,X.valLblV,`V`),r(X.sliderR,X.valLblR,`R`),r(X.sliderL,X.valLblL,`L`),r(X.sliderC,X.valLblC,`C`),r(X.sliderf,X.valLblf,`f`),r(X.sliderT,X.valLblT,`T`),X.btnExport.addEventListener(`click`,()=>{if(Y.dataPoints.length===0)return;let e=`Index,Voltage (V),Current (A),${Y.activeExperiment===`ohms`?`Resistance (Ohm)`:`Impedance (Ohm)`}\n`;Y.dataPoints.forEach(t=>{e+=`${t.id},${t.V.toFixed(2)},${t.I.toFixed(4)},${t.R.toFixed(1)}\n`});let t=new Blob([e],{type:`text/csv`}),n=document.createElement(`a`);n.href=URL.createObjectURL(t),n.download=`circuit_iq_3d_${Y.activeExperiment}_data.csv`,n.click()}),X.btnDownloadReport.addEventListener(`click`,()=>{Dp(),ah(`Downloaded PDF Lab Report.`,100)});let i=document.getElementById(`cb-zoom-in`),a=document.getElementById(`cb-zoom-out`),o=document.getElementById(`cb-fit`),s=document.getElementById(`cb-front`),c=document.getElementById(`cb-top`),l=document.getElementById(`cb-side`),u=document.getElementById(`cb-wire`);i&&i.addEventListener(`click`,()=>{$p=Math.max(4,$p-1.5)}),a&&a.addEventListener(`click`,()=>{$p=Math.min(20,$p+1.5)}),o&&o.addEventListener(`click`,()=>{$p=11.715,rm=0,im=Math.atan2(7.5,9)}),s&&s.addEventListener(`click`,()=>{rm=0,im=Math.atan2(7.5,9)}),c&&c.addEventListener(`click`,()=>{rm=0,im=Math.PI/2-.01}),l&&l.addEventListener(`click`,()=>{rm=Math.PI/2,im=Math.atan2(7.5,9)}),u&&u.addEventListener(`click`,()=>{Y.selectedTool=Y.selectedTool===`wire`?null:`wire`,u.classList.toggle(`active`,Y.selectedTool===`wire`),Y.selectedTool===`wire`&&op(`Circuit IQ · AI Mentor`,`Wiring tool active. Click snaps on board.`),wp(),Rp()}),X.aiSend&&X.aiInput&&(X.aiSend.addEventListener(`click`,jp),X.aiInput.addEventListener(`keydown`,e=>{e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),jp())})),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(document.activeElement.tagName===`INPUT`||document.activeElement.tagName===`TEXTAREA`)return;let n=null;if(t===`w`)n=`wire`;else if(t===`l`)n=`led`;else if(t===`b`)n=`button`;else if(t===`r`)n=`resistor`;else if(t===`d`)n=`diode`;else if(t===`t`)n=`transistor`;else if(t===`s`)n=`display`;else if(t===`+`||t===`-`)n=`source`;else if(t===`a`)n=`ammeter`;else if(t===`v`)n=`voltmeter`;else if(t===`escape`){if(Y.selectedComponentIdx!==-1){Y.selectedComponentIdx=-1,Nm(!0),Jm(),op(`Circuit IQ · AI Mentor`,`Component deselected.`);return}if(Y.selectedHoleIndex!==null){Y.selectedHoleIndex=null,Jm(),op(`Circuit IQ · AI Mentor`,`Hole selection cleared.`);return}if(Y.isDraggingComponent&&Y.draggedComponentIdx!==-1){let e=Y.placedComponents[Y.draggedComponentIdx];Z.remove(e.mesh),e.leads.forEach(e=>Z.remove(e));let t=Vm(e.type,Y.dragStartSnap1,Y.dragStartSnap2,e.color);e.mesh=t.mesh,e.leads=t.leads,e.snap1=Y.dragStartSnap1,e.snap2=Y.dragStartSnap2,Z.add(e.mesh),e.leads.forEach(e=>Z.add(e)),Nm(),Y.isDraggingComponent=!1,Y.draggedComponentIdx=-1,Y.dragStartSnap1=null,Y.dragStartSnap2=null,Y.wasRunningBeforeDrag&&(Y.isRunning=!0,tp(),Yf(!0),X.btnRun&&(X.btnRun.style.display=`none`),X.btnStop&&(X.btnStop.style.display=`block`),X.statusDot&&(X.statusDot.style.background=`var(--red)`),X.statusTextBar&&(X.statusTextBar.innerText=`RUNNING`)),op(`Circuit IQ · AI Mentor`,`Component move cancelled.`),vp(),Bp(),Rp();return}if(Y.isDraggingWireEnd&&Y.draggedWireIdx!==-1){let e=Y.wires[Y.draggedWireIdx],t=e.fromHole,n=e.toHole;Y.draggedWireEnd===0?t=Y.dragStartWireHole:n=Y.dragStartWireHole,Xm(Y.draggedWireIdx,t,n),Y.isDraggingWireEnd=!1,Y.draggedWireIdx=-1,Y.draggedWireEnd=-1,Y.dragStartWireHole=null,Y.wasRunningBeforeDrag&&(Y.isRunning=!0,tp(),Yf(!0),X.btnRun&&(X.btnRun.style.display=`none`),X.btnStop&&(X.btnStop.style.display=`block`),X.statusDot&&(X.statusDot.style.background=`var(--red)`),X.statusTextBar&&(X.statusTextBar.innerText=`RUNNING`)),op(`Circuit IQ · AI Mentor`,`Wire move cancelled.`),vp(),Bp(),Rp();return}Y.selectedTool=null,Y.placementStartHole=null,Y.wiringStart=null,document.querySelectorAll(`.comp-chip:not([data-type^="bb_"])`).forEach(e=>e.classList.remove(`selected`)),op(`Circuit IQ · AI Mentor`,`Tool deselected.`),wp();return}else t===`delete`&&(n=`eraser`);if(n){if(document.querySelectorAll(`.comp-chip:not([data-type^="bb_"])`).forEach(e=>e.classList.remove(`selected`)),Y.selectedTool===n)Y.selectedTool=null,op(`Circuit IQ · AI Mentor`,`Tool deselected.`);else{Y.selectedTool=n;let e=document.querySelector(`.comp-chip[data-type="${n===`wire`?`wire`:n===`led`?`led`:n}"]`);e&&e.classList.add(`selected`),op(`Circuit IQ · AI Mentor`,`Selected ${n.toUpperCase()} via hotkey.`)}Y.placementStartHole=null,Y.wiringStart=null,wp(),Rp()}}),document.querySelectorAll(`#left-panel .lp-section-hdr`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.closest(`.lp-section`);t&&t.classList.toggle(`collapsed`)})})}async function jp(){let e=X.aiInput.value.trim();if(!e)return;X.aiInput.value=``,op(`User`,e,!0);let t=document.createElement(`div`);t.className=`ai-msg`,t.innerHTML=`
  ...
  `,X.aiMessagesContainer.appendChild(t),X.aiMessagesContainer.scrollTop=X.aiMessagesContainer.scrollHeight;try{let n=await fetch(`/api/physicsbot/ask`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({question:e,experiment:Y.activeExperiment,circuit_state:{placed_components:Y.placedComponents.map((e,t)=>({type:e.type,id:t})),wires:Fp(),params:Y.params,readings:{volts:Y.meters.volts,amps:Y.meters.amps,ohms:Y.meters.ohms,power:Y.meters.power}}})});if(t.parentNode&&t.parentNode.removeChild(t),n.ok)op(`Circuit IQ · AI Mentor`,(await n.json()).answer);else throw Error(`HTTP ${n.status}`)}catch(n){console.error(`AI Mentor API request failed, using local rules:`,n),t.parentNode&&t.parentNode.removeChild(t);let r=`I am your Circuit IQ AI Mentor. Please specify what help you need (e.g. ask 'how to connect', 'formula', or 'readings').`,i=e.toLowerCase();i.includes(`connect`)||i.includes(`how to`)||i.includes(`wire`)||i.includes(`step`)?r=`Here is the current connection step for **${Xf[Y.activeExperiment].name}**:<br><br>${zp()}`:i.includes(`formula`)||i.includes(`equation`)||i.includes(`law`)?r=`Here are the formulas for the current experiment:<br><br>${Xf[Y.activeExperiment].formulas.map(e=>`• **${e.name}**: \`${e.expr}\``).join(`<br>`)}`:i.includes(`reading`)||i.includes(`meter`)||i.includes(`volt`)||i.includes(`amp`)?r=`Current digital telemetry measurements:<br>• **Voltage (V)**: \`${Y.meters.volts.toFixed(2)} V\`<br>• **Current (I)**: \`${Y.meters.amps.toFixed(4)} A\`<br>• **Impedance (Z)**: \`${Y.meters.ohms.toFixed(2)} Ω\`<br>• **Power (P)**: \`${Y.meters.power.toFixed(2)} W\``:i.includes(`resonance`)||i.includes(`frequency`)||i.includes(`lcr`)?r=Y.activeExperiment===`lcr`?`In the Series LCR circuit, resonance occurs where Z is minimum and equal to R. Resonant frequency **f₀ = ${Y.analysis.f0.toFixed(1)} Hz**.<br>Reactance values:<br>• **XL (Inductance)**: \`${Y.analysis.XL.toFixed(1)} Ω\`<br>• **XC (Capacitance)**: \`${Y.analysis.XC.toFixed(1)} Ω\`<br>• **Phase Shift φ**: \`${Y.analysis.phi.toFixed(1)}°\``:`LCR Resonance formulas are active in EXP-03 Series LCR Laboratory.`:i.includes(`time constant`)||i.includes(`tau`)||i.includes(`charging`)?r=Y.activeExperiment===`rc`?`For the RC Time Constant, **τ = R × C** is equal to **${(Y.params.R*Y.params.C*1e-6*1e3).toFixed(1)} ms** (with R = ${Y.params.R} Ω, C = ${Y.params.C} µF). The capacitor reaches ~63.2% charge at t = τ, and full charge (~99%) at t = 5τ.`:`Time constant charging calculations are active in EXP-04 RC Time Constant Laboratory.`:(i.includes(`hello`)||i.includes(`hi`)||i.includes(`hey`))&&(r=`Hello! I am your interactive AI Mentor. Ask me about circuit connections, formulas, or current measurements!`),op(`Circuit IQ · AI Mentor`,r)}}async function Mp(){try{let e=$f();if(e.status===`success`&&[`ohms`,`kvl`,`kcl`,`rc_rl_rlc`,`series_parallel`,`wheatstone`,`lcr`,`rc`,`arduino_led`].includes(Y.activeExperiment)&&Y.activeExperiment!==`arduino_led`)try{let t=await fetch(`/api/validate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({placed_components:Y.placedComponents.map((e,t)=>({type:e.type,id:t})),wires:Fp(),required_types:Xf[Y.activeExperiment].req||[]})});if(t.ok){let n=await t.json();e=n.status===`success`?{status:`success`,message:n.message}:{status:`error`,message:`Backend validation failure: `+n.message}}else throw Error(`HTTP ${t.status}`)}catch(e){console.warn(`Backend validation failed, falling back to local validation.`,e)}e.status===`success`?(Y.isRunning=!0,Y.energyStartTime=Date.now(),Y.experimentStartTime=Date.now(),tp(),Yf(!0),X.btnRun&&(X.btnRun.style.display=`none`),X.btnStop&&(X.btnStop.style.display=`block`),X.statusDot&&(X.statusDot.style.background=`var(--red)`),X.statusTextBar&&(X.statusTextBar.innerText=`RUNNING`),op(`Circuit IQ · AI Mentor`,`Loop validated successfully: `+e.message),Y.activeExperiment===`ohms`?_p(5):Y.activeExperiment===`lcr`||Y.activeExperiment===`rc`?_p(3):Y.activeExperiment===`arduino_led`&&(_p(4),_p(5))):op(`Circuit IQ · AI Mentor`,`Validation Failure: `+e.message)}catch(e){console.error(`Simulation start failed:`,e)}}function Np(){pp(Y.activeExperiment,!1);let e=Y.activeExperiment;e===`ohms`?(Hm(`source`,14,15),Hm(`resistor`,130,200),Hm(`ammeter`,203,273),Hm(`voltmeter`,128,198),Zm(126,130),Zm(200,203),Zm(273,267),Zm(128,130),Zm(198,200)):e===`kvl`?(Hm(`source`,14,15),Hm(`resistor`,102,158),Hm(`resistor`,186,242),Zm(14,102),Zm(158,186),Zm(242,15)):e===`kcl`?(Hm(`source`,14,15),Hm(`resistor`,115,171),Hm(`resistor`,117,173),Zm(14,115),Zm(115,117),Zm(171,173),Zm(173,15)):e===`led`?(Hm(`source`,42,43),Hm(`resistor`,88,130),Hm(`led`,131,132),Zm(42,88),Zm(130,131),Zm(132,43)):e===`rc_rl_rlc`||e===`lcr`?(Hm(`source`,14,15),Hm(`resistor`,102,158),Hm(`inductor`,159,215),Hm(`capacitor`,216,272),Zm(98,102),Zm(158,159),Zm(215,216),Zm(272,267)):e===`rc`?(Hm(`source`,14,15),Hm(`resistor`,130,200),Hm(`capacitor`,201,271),Zm(126,130),Zm(200,201),Zm(271,267)):e===`series_parallel`?(Hm(`source`,14,15),Hm(`resistor`,102,158),Hm(`resistor`,158,214),Zm(98,102),Zm(214,211)):e===`wheatstone`?(Hm(`source`,14,15),Hm(`resistor`,87,143),Hm(`resistor`,143,199),Hm(`resistor`,89,145),Hm(`resistor`,145,201),Zm(14,87),Zm(87,89),Zm(199,201),Zm(201,15)):e===`arduino_led`&&(Hm(`source`,14,15),Hm(`button`,160,161),Hm(`led`,216,244),Hm(`resistor`,245,301),Zm(882,160),Zm(161,216),Zm(244,245),Zm(301,883))}function Pp(){let e={parent:Array.from({length:884},(e,t)=>t),find(e){return this.parent[e]===e?e:(this.parent[e]=this.find(this.parent[e]),this.parent[e])},union(e,t){let n=this.find(e),r=this.find(t);n!==r&&(this.parent[n]=r)}};for(let t=0;t<tm;t++){for(let n=2;n<6;n++)e.union(t*14+n,t*14+n+1);for(let n=7;n<11;n++)e.union(t*14+n,t*14+n+1)}for(let t=0;t<tm-1;t++)e.union(t*14+0,(t+1)*14+0),e.union(t*14+1,(t+1)*14+1),e.union(t*14+12,(t+1)*14+12),e.union(t*14+13,(t+1)*14+13);return Y.wires.forEach(t=>{e.union(t.fromHole,t.toHole)}),e}function Fp(){let e=Pp(),t=[];for(let n=0;n<Y.placedComponents.length;n++){let r=Y.placedComponents[n];for(let i=n+1;i<Y.placedComponents.length;i++){let a=Y.placedComponents[i];e.find(r.snap1)===e.find(a.snap1)&&t.push([[n,0],[i,0]]),e.find(r.snap1)===e.find(a.snap2)&&t.push([[n,0],[i,1]]),e.find(r.snap2)===e.find(a.snap1)&&t.push([[n,1],[i,0]]),e.find(r.snap2)===e.find(a.snap2)&&t.push([[n,1],[i,1]])}}return t}function Ip(e){if(e===882)return`Arduino 5V`;if(e===883)return`Arduino GND`;let t=Math.floor(e/14)+1,n=e%14;return n===0?`Top (+) Col ${t}`:n===1?`Top (-) Col ${t}`:n>=2&&n<=6?`Col ${t}, Row ${String.fromCharCode(65+(n-2))}`:n>=7&&n<=11?`Col ${t}, Row ${String.fromCharCode(70+(n-7))}`:n===12?`Bottom (+) Col ${t}`:n===13?`Bottom (-) Col ${t}`:`Socket ${e}`}function Lp(){let e=document.getElementById(`guide-label-1`),t=document.getElementById(`guide-label-2`);if(!(!e||!t))if(Y.targetSnap1!==null&&Y.targetSnap2!==null&&Y.selectedTool===`wire`&&Vp&&Hp){let n=sm(Y.targetSnap1),r=sm(Y.targetSnap2),i=n.clone().project(Vp),a=r.clone().project(Vp),o=Hp.domElement.getBoundingClientRect(),s=o.left+(i.x*.5+.5)*o.width,c=o.top+(-(i.y*.5)+.5)*o.height,l=o.left+(a.x*.5+.5)*o.width,u=o.top+(-(a.y*.5)+.5)*o.height;e.style.left=`${s}px`,e.style.top=`${c-15}px`,e.classList.remove(`hidden`),e.innerHTML=`WIRE START<br><b>${Ip(Y.targetSnap1)}</b>`,t.style.left=`${l}px`,t.style.top=`${u-15}px`,t.classList.remove(`hidden`),t.innerHTML=`WIRE END<br><b>${Ip(Y.targetSnap2)}</b>`}else e.classList.add(`hidden`),t.classList.add(`hidden`)}function Rp(){if(!Z)return;Q&&Z.remove(Q),$&&Z.remove($),Xp&&=(Z.remove(Xp),null),Q=null,$=null,Y.targetSnap1=null,Y.targetSnap2=null;let e=(e,t=!1)=>{if(t){let t=Km();e=qm(e,t)}let n=sm(e);if(!n)return null;let r=new U(new Io(.08,.12,32),new Jr({color:2278750,side:2}));if(r.rotation.x=-Math.PI/2,r.position.set(n.x,.09,n.z),Z.add(r),Y.targetSnap1===null)Y.targetSnap1=e;else if(Y.targetSnap2===null){Y.targetSnap2=e;let t=sm(Y.targetSnap1),r=n,i=new B().addVectors(t,r).multiplyScalar(.5);i.y+=Math.min(1.5,Math.max(.4,t.distanceTo(r)*.35+.1));let a=new Ea([t,i,r]).getPoints(30);Xp=new Ji(new Pr().setFromPoints(a),new $o({color:2278750,dashSize:.1,gapSize:.06})),Xp.computeLineDistances(),Z.add(Xp)}return r},t=Y.placedComponents,n=e=>t.find(t=>t.type===e),r=Pp();if(Y.activeExperiment===`ohms`){let t=n(`source`),i=n(`resistor`),a=n(`ammeter`),o=n(`voltmeter`);if(!t)(!Y.selectedTool||Y.selectedTool===`source`)&&(Q=e(14),$=e(15));else if(!i)(!Y.selectedTool||Y.selectedTool===`resistor`)&&(Q=e(130),$=e(200));else if(!a)(!Y.selectedTool||Y.selectedTool===`ammeter`)&&(Q=e(203),$=e(273));else if(!o)(!Y.selectedTool||Y.selectedTool===`voltmeter`)&&(Q=e(128),$=e(198));else if(!Y.selectedTool||Y.selectedTool===`wire`){let t=i.snap1,n=i.snap2,s=a.snap1,c=a.snap2,l=o.snap1,u=o.snap2;if(!(r.find(126)===r.find(t)||r.find(126)===r.find(n))){Q=e(126,!0),$=e(t,!0);return}if(!(r.find(n)===r.find(s)||r.find(n)===r.find(c))){Q=e(n,!0),$=e(s,!0);return}if(r.find(c)!==r.find(267)){Q=e(c,!0),$=e(267,!0);return}if(r.find(l)!==r.find(t)){Q=e(l,!0),$=e(t,!0);return}if(r.find(u)!==r.find(n)){Q=e(u,!0),$=e(n,!0);return}}}else if(Y.activeExperiment===`lcr`){let t=n(`source`),i=n(`resistor`),a=n(`inductor`),o=n(`capacitor`);if(!t)(!Y.selectedTool||Y.selectedTool===`source`)&&(Q=e(14),$=e(15));else if(!i)(!Y.selectedTool||Y.selectedTool===`resistor`)&&(Q=e(102),$=e(158));else if(!a)(!Y.selectedTool||Y.selectedTool===`inductor`)&&(Q=e(159),$=e(215));else if(!o)(!Y.selectedTool||Y.selectedTool===`capacitor`)&&(Q=e(216),$=e(272));else if(!Y.selectedTool||Y.selectedTool===`wire`){let t=i.snap1,n=i.snap2,s=a.snap1,c=a.snap2,l=o.snap1,u=o.snap2;if(r.find(98)!==r.find(t)){Q=e(98,!0),$=e(t,!0);return}if(r.find(n)!==r.find(s)){Q=e(n,!0),$=e(s,!0);return}if(r.find(c)!==r.find(l)){Q=e(c,!0),$=e(l,!0);return}if(r.find(u)!==r.find(267)){Q=e(u,!0),$=e(267,!0);return}}}else if(Y.activeExperiment===`rc`){let t=n(`source`),i=n(`resistor`),a=n(`capacitor`);if(!t)(!Y.selectedTool||Y.selectedTool===`source`)&&(Q=e(14),$=e(15));else if(!i)(!Y.selectedTool||Y.selectedTool===`resistor`)&&(Q=e(130),$=e(200));else if(!a)(!Y.selectedTool||Y.selectedTool===`capacitor`)&&(Q=e(201),$=e(271));else if(!Y.selectedTool||Y.selectedTool===`wire`){let t=i.snap1,n=i.snap2,o=a.snap1,s=a.snap2;if(r.find(126)!==r.find(t)){Q=e(126,!0),$=e(t,!0);return}if(r.find(n)!==r.find(o)){Q=e(n,!0),$=e(o,!0);return}if(r.find(s)!==r.find(267)){Q=e(s,!0),$=e(267,!0);return}}}else if(Y.activeExperiment===`arduino_led`){let t=n(`source`),i=n(`button`)||n(`toggle_switch`),a=n(`led`),o=n(`resistor`);if(!t)(!Y.selectedTool||Y.selectedTool===`source`)&&(Q=e(14),$=e(15));else if(!i)(!Y.selectedTool||Y.selectedTool===`button`||Y.selectedTool===`toggle_switch`)&&(Q=e(160),$=e(161));else if(!a)(!Y.selectedTool||Y.selectedTool===`led`)&&(Q=e(216),$=e(244));else if(!o)(!Y.selectedTool||Y.selectedTool===`resistor`)&&(Q=e(245),$=e(301));else if(!Y.selectedTool||Y.selectedTool===`wire`){let t=i.snap1,n=i.snap2,s=a.snap1,c=a.snap2,l=o.snap1,u=o.snap2,d=r.find(882)===r.find(t)||r.find(882)===r.find(n),f=d?r.find(882)===r.find(t)?t:n:null,p=d?f===t?n:t:null,m=p&&(r.find(p)===r.find(s)||r.find(p)===r.find(c)),h=m?r.find(p)===r.find(s)?s:c:null,g=m?h===s?c:s:null,_=g&&(r.find(g)===r.find(l)||r.find(g)===r.find(u)),v=_?r.find(g)===r.find(l)?l:u:null,y=_?v===l?u:l:null,b=y&&r.find(y)===r.find(883);if(!d){Q=e(882,!0),$=e(t,!0);return}if(!m){Q=e(p,!0),$=e(s,!0);return}if(!_){Q=e(g,!0),$=e(l,!0);return}if(!b){Q=e(y,!0),$=e(883,!0);return}}}}function zp(){let e=Y.placedComponents,t=t=>e.find(e=>e.type===t),n=t(`source`),r=t(`resistor`),i=t(`inductor`),a=t(`capacitor`),o=t(`ammeter`),s=t(`voltmeter`);if(Y.activeExperiment===`ohms`){if(!n)return`<b>Step 1: Place DC Source</b><br>Select <b>DC Power Source</b> <i class='fa-solid fa-plug'></i> and click glowing green Top Rails slots (Col 2, Row +/-).`;if(!r)return`<b>Step 2: Place Resistor</b><br>Select <b>Ceramic Resistor</b> <i class='fa-solid fa-wave-square'></i> and place horizontally between Col 10, Row C and Col 15, Row C.`;if(!o)return`<b>Step 3: Place Ammeter</b><br>Select <b>Ammeter (Series)</b> <i class='fa-solid fa-gauge-simple-high'></i> and place horizontally between Col 15, Row D and Col 20, Row D.`;if(!s)return`<b>Step 4: Place Voltmeter</b><br>Select <b>Voltmeter (Parallel)</b> <i class='fa-solid fa-gauge-simple'></i> and place horizontally between Col 10, Row B and Col 15, Row B.`;let e=Pp(),t=r.snap1,i=r.snap2,a=o.snap1,c=o.snap2,l=s.snap1,u=s.snap2;return e.find(126)===e.find(t)||e.find(126)===e.find(i)?e.find(i)===e.find(a)||e.find(i)===e.find(c)?e.find(c)===e.find(267)?e.find(l)===e.find(t)?e.find(u)===e.find(i)?Y.isRunning?Y.dataPoints.length<5?`<b>Step 7: Record Data Points</b><br>Circuit is active! Adjust parameters on the right and click <b>Record Point</b> (${5-Y.dataPoints.length} remaining).`:`<b>Complete!</b><br>Ohm's Law verified! Answer the Viva questions in the Report panel.`:`<b>Step 6: Initialize Circuit</b><br>Wiring complete! Click <b>INITIALIZE</b> in the top bar to power on the circuit.`:`<b>Step 5: Wire Voltmeter 2</b><br>Wire **Voltmeter terminal 2** (${Ip(u)}) to **Resistor terminal 2** (${Ip(i)}).`:`<b>Step 5: Wire Voltmeter 1</b><br>Wire **Voltmeter terminal 1** (${Ip(l)}) to **Resistor terminal 1** (${Ip(t)}).`:`<b>Step 5: Wire Ammeter to (-) Rail</b><br>Wire **Ammeter end** (${Ip(c)}) to **Top (-) Rail (Col 20)**.`:`<b>Step 5: Wire Resistor to Ammeter</b><br>Wire **Resistor end** (${Ip(i)}) to **Ammeter start** (${Ip(a)}).`:`<b>Step 5: Wire (+) Rail to Resistor</b><br>Wire **Top (+) Rail (Col 10)** to **Resistor start** (${Ip(t)}).`}if(Y.activeExperiment===`lcr`){if(!n)return`<b>Step 1: Place AC Source</b><br>Select <b>DC Power Source</b> <i class='fa-solid fa-plug'></i> and click glowing green Top Rails slots (Col 2, Row +/-).`;if(!r)return`<b>Step 2: Place Resistor</b><br>Select <b>Ceramic Resistor</b> <i class='fa-solid fa-wave-square'></i> and place horizontally between Col 8, Row C and Col 12, Row C.`;if(!i)return`<b>Step 3: Place Inductor</b><br>Select <b>Copper Inductor</b> <i class='fa-solid fa-circle-notch'></i> and place horizontally between Col 12, Row D and Col 16, Row D.`;if(!a)return`<b>Step 4: Place Capacitor</b><br>Select <b>Electrolytic Capacitor</b> <i class='fa-solid fa-grip-lines-vertical'></i> and place horizontally between Col 16, Row E and Col 20, Row E.`;let e=Pp(),t=r.snap1,o=r.snap2,s=i.snap1,c=i.snap2,l=a.snap1,u=a.snap2;return e.find(98)===e.find(t)?e.find(o)===e.find(s)?e.find(c)===e.find(l)?e.find(u)===e.find(267)?Y.isRunning?`<b>Step 7: Find Resonance</b><br>Vary the **Source Frequency** slider to find the resonance peak (minimum Z / maximum I).`:`<b>Step 6: Initialize Circuit</b><br>Wiring complete! Click <b>INITIALIZE</b> in the top bar to start the LCR simulation.`:`<b>Step 5: Wire Capacitor to (-) Rail</b><br>Wire **Capacitor end** (${Ip(u)}) to **Top (-) Rail (Col 20)**.`:`<b>Step 5: Wire Inductor to Capacitor</b><br>Wire **Inductor end** (${Ip(c)}) to **Capacitor start** (${Ip(l)}).`:`<b>Step 5: Wire Resistor to Inductor</b><br>Wire **Resistor end** (${Ip(o)}) to **Inductor start** (${Ip(s)}).`:`<b>Step 5: Wire (+) Rail to Resistor</b><br>Wire **Top (+) Rail (Col 8)** to **Resistor start** (${Ip(t)}).`}if(Y.activeExperiment===`rc`){if(!n)return`<b>Step 1: Place DC Source</b><br>Select <b>DC Power Source</b> <i class='fa-solid fa-plug'></i> and click glowing green Top Rails slots (Col 2, Row +/-).`;if(!r)return`<b>Step 2: Place Resistor</b><br>Select <b>Ceramic Resistor</b> <i class='fa-solid fa-wave-square'></i> and place horizontally between Col 10, Row C and Col 15, Row C.`;if(!a)return`<b>Step 3: Place Capacitor</b><br>Select <b>Electrolytic Capacitor</b> <i class='fa-solid fa-grip-lines-vertical'></i> and place horizontally between Col 15, Row D and Col 20, Row D.`;let e=Pp(),t=r.snap1,i=r.snap2,o=a.snap1,s=a.snap2;return e.find(126)===e.find(t)?e.find(i)===e.find(o)?e.find(s)===e.find(267)?Y.isRunning?`<b>Step 6: Observe Charge</b><br>Watch the curve on the oscilloscope. Adjust R or C to change time constant τ = RC.`:`<b>Step 5: Initialize Circuit</b><br>Wiring complete! Click <b>INITIALIZE</b> in the top bar to start charging.`:`<b>Step 4: Wire Capacitor to (-) Rail</b><br>Wire **Capacitor end** (${Ip(s)}) to **Top (-) Rail (Col 20)**.`:`<b>Step 4: Wire Resistor to Capacitor</b><br>Wire **Resistor end** (${Ip(i)}) to **Capacitor start** (${Ip(o)}).`:`<b>Step 4: Wire (+) Rail to Resistor</b><br>Wire **Top (+) Rail (Col 10)** to **Resistor start** (${Ip(t)}).`}if(Y.activeExperiment===`arduino_led`){let e=t(`button`)||t(`toggle_switch`),r=t(`led`),i=t(`resistor`);if(!n)return`<b>Step 1: Connect USB Power</b><br>Select <b>DC Power Source</b> <i class='fa-solid fa-plug'></i> and click board to power the Arduino Uno.`;if(!e)return`<b>Step 2: Mount Switch</b><br>Select <b>Push Button</b> or <b>ON/OFF Switch</b> and mount across center ravine (Col 12, Row E/F).`;if(!r)return`<b>Step 3: Mount LED</b><br>Select <b>Red LED</b> <i class='fa-solid fa-lightbulb'></i> and place horizontally between Col 16, Row E and Col 18, Row E.`;if(!i)return`<b>Step 4: Mount Resistor</b><br>Select <b>Ceramic Resistor</b> <i class='fa-solid fa-wave-square'></i> and place horizontally between Col 18, Row F and Col 22, Row F.`;let a=Pp(),o=e.snap1,s=e.snap2,c=r.snap1,l=r.snap2,u=i.snap1,d=i.snap2,f=a.find(882)===a.find(o)||a.find(882)===a.find(s),p=f?a.find(882)===a.find(o)?o:s:null,m=f?p===o?s:o:null,h=m&&(a.find(m)===a.find(c)||a.find(m)===a.find(l)),g=h?a.find(m)===a.find(c)?c:l:null,_=h?g===c?l:c:null,v=_&&(a.find(_)===a.find(u)||a.find(_)===a.find(d)),y=v?a.find(_)===a.find(u)?u:d:null,b=v?y===u?d:u:null,x=b&&a.find(b)===a.find(883);return f?h?v?x?Y.isRunning?Y.buttonPressed?`<b>Complete!</b><br>LED is glowing! Answer the Viva questions in the Report panel.`:`<b>Step 7: Press Switch</b><br>Click and hold the red button plunger to light up the LED!`:`<b>Step 6: Initialize Arduino</b><br>Wiring complete! Click <b>INITIALIZE</b> in the top bar to power the board.`:`<b>Step 5: Wire Resistor to GND</b><br>Wire remaining **Resistor terminal** (${Ip(b)}) to **Arduino GND**.`:`<b>Step 5: Wire LED to Resistor</b><br>Wire **LED Cathode** (${Ip(_)}) to **Resistor start** (${Ip(u)}).`:`<b>Step 5: Wire Button to LED</b><br>Wire **Push Button bottom** (${Ip(m)}) to **LED Anode** (${Ip(c)}).`:`<b>Step 5: Wire Arduino 5V to Button</b><br>Wire **Arduino 5V** to **Push Button top** (${Ip(o)}).`}return`System online. Select an experiment to begin.`}function Bp(){let e=zp();X.aiMessage.innerHTML=e;let t=1,n=e.match(/Step\s+(\d+)/i);n?t=parseInt(n[1],10):e.includes(`Complete!`)&&(t=999),X.stepsContainer.querySelectorAll(`.step-item`).forEach((e,n)=>{let r=n+1,i=e.querySelector(`.step-num`);r<t?(e.className=`step-item done`,i&&(i.className=`step-num done`)):r===t?(e.className=`step-item cur`,i&&(i.className=`step-num cur`)):(e.className=`step-item`,i&&(i.className=`step-num`))})}var Z,Vp,Hp,Up,Wp=null,Gp=null,Kp,qp,Jp,Yp,Q,$,Xp=null,Zp=null,Qp=null,$p=11.715,em=11.715,tm=63,nm=null,rm=0,im=Math.atan2(7.5,9),am=Math.atan2(7.5,9),om=Array.from({length:63},(e,t)=>-4.72+t*.1522);function sm(e){if(e===882){if(qp){qp.updateMatrix();let e=new B(.2,.15,.9);return e.applyMatrix4(qp.matrix),e}return new B(.2,.2,-2.3)}if(e===883){if(qp){qp.updateMatrix();let e=new B(.4,.15,.9);return e.applyMatrix4(qp.matrix),e}return new B(.4,.2,-2.3)}let t=Math.floor(e/14),n=e%14,r=om[t],i=0;n===0?i=-1.296:n===1?i=-1.144:n>=2&&n<=6?i=-.839+(n-2)*.1522:n>=7&&n<=11?i=.229+(n-7)*.1522:n===12?i=1.144:n===13&&(i=1.296);let a=new B(r,.08,i);return nm&&(nm.updateMatrix(),a.applyMatrix4(nm.matrix)),a}function cm(){let e=new jn,t=new U(new W(3,.06,2.2),new K({color:23426,roughness:.5}));t.receiveShadow=!0,e.add(t);let n=new U(new W(.8,.4,.6),new K({color:13751771,metalness:.9,roughness:.1}));n.position.set(-1.1,.23,-.6),e.add(n);let r=new U(new W(.7,.45,.5),new K({color:1120295,roughness:.5}));r.position.set(-1.1,.25,.6),e.add(r);let i=new U(new W(1.2,.12,.35),new K({color:2042167,roughness:.6}));i.position.set(.2,.09,.25),e.add(i);let a=new K({color:2042167,roughness:.6}),o=new U(new W(1.6,.18,.15),a);o.position.set(.3,.12,-.9),e.add(o);let s=new U(new W(1.4,.18,.15),a);return s.position.set(.3,.12,.9),e.add(s),Jp=new U(new W(.1,.22,.1),new K({color:15680580,metalness:.8,roughness:.2})),Jp.position.set(.2,.15,.9),Jp.userData={snapIndex:882},e.add(Jp),Yp=new U(new W(.1,.22,.1),new K({color:1976635,metalness:.8,roughness:.2})),Yp.userData={snapIndex:883},e.add(Yp),e}function lm(e=63,t=10){let n=2048,r=1024,i=document.createElement(`canvas`);i.width=n,i.height=r;let a=i.getContext(`2d`),o=document.createElement(`canvas`);o.width=n,o.height=r;let s=o.getContext(`2d`);a.fillStyle=`#faf8f2`,a.fillRect(0,0,n,r),s.fillStyle=`#8080ff`,s.fillRect(0,0,n,r);for(let e=0;e<8e4;e++){let e=Math.random()*n,t=Math.random()*r,i=Math.random()*1.5+.5;a.fillStyle=Math.random()>.5?`rgba(255, 255, 255, 0.3)`:`rgba(0, 0, 0, 0.04)`,a.fillRect(e,t,i,i)}let c=s.createLinearGradient(0,0,25,0);c.addColorStop(0,`#a080ff`),c.addColorStop(1,`#8080ff`),s.fillStyle=c,s.fillRect(0,0,25,r),c=s.createLinearGradient(n-25,0,n,0),c.addColorStop(0,`#8080ff`),c.addColorStop(1,`#6080ff`),s.fillStyle=c,s.fillRect(n-25,0,25,r),c=s.createLinearGradient(0,0,0,25),c.addColorStop(0,`#8060ff`),c.addColorStop(1,`#8080ff`),s.fillStyle=c,s.fillRect(0,0,n,25),c=s.createLinearGradient(0,r-25,0,r),c.addColorStop(0,`#8080ff`),c.addColorStop(1,`#80a0ff`),s.fillStyle=c,s.fillRect(0,r-25,n,25);let l=t/2;function u(e,i){return{x:(e- -l)/t*n,y:(i- -1.82)/3.64*r}}[{z1:-1.04,z2:-.94},{z1:-.18,z2:.18},{z1:.94,z2:1.04}].forEach(e=>{let t=u(0,e.z1),r=u(0,e.z2),i=t.y,o=r.y,c=o-i,l=a.createLinearGradient(0,i,0,o);l.addColorStop(0,`#dfded6`),l.addColorStop(.2,`#c4c3b8`),l.addColorStop(.5,`#9a9993`),l.addColorStop(.8,`#c4c3b8`),l.addColorStop(1,`#dfded6`),a.fillStyle=l,a.fillRect(30,i,n-50-10,c);let d=s.createLinearGradient(0,i,0,o);d.addColorStop(0,`#8080ff`),d.addColorStop(.45,`#8060ff`),d.addColorStop(.5,`#8080ff`),d.addColorStop(.55,`#80a0ff`),d.addColorStop(1,`#8080ff`),s.fillStyle=d,s.fillRect(30,i,n-50-10,c)});let d=u(0,-1.37).y,f=u(0,-1.07).y,p=u(0,1.07).y,m=u(0,1.37).y;a.lineWidth=4,a.strokeStyle=`#ef4444`,a.beginPath(),a.moveTo(60,d),a.lineTo(n-60,d),a.stroke(),a.strokeStyle=`#3b82f6`,a.beginPath(),a.moveTo(60,f),a.lineTo(n-60,f),a.stroke(),a.strokeStyle=`#ef4444`,a.beginPath(),a.moveTo(60,p),a.lineTo(n-60,p),a.stroke(),a.strokeStyle=`#3b82f6`,a.beginPath(),a.moveTo(60,m),a.lineTo(n-60,m),a.stroke(),a.font=`bold 24px sans-serif`,a.textAlign=`center`,a.textBaseline=`middle`,a.fillStyle=`#ef4444`,a.fillText(`+`,45,d-2),a.fillText(`+`,n-45,d-2),a.fillStyle=`#3b82f6`,a.fillText(`-`,45,f-2),a.fillText(`-`,n-45,f-2),a.fillStyle=`#ef4444`,a.fillText(`+`,45,p-2),a.fillText(`+`,n-45,p-2),a.fillStyle=`#3b82f6`,a.fillText(`-`,45,m-2),a.fillText(`-`,n-45,m-2);function h(e,t,n,r){let i=r/2;e.fillStyle=`#d5d4cb`,e.beginPath(),e.roundRect(t-i-1.5,n-i-1.5,r+3,r+3,2.5),e.fill();let a=e.createLinearGradient(t,n-i,t,n+i);a.addColorStop(0,`#0a0a0b`),a.addColorStop(.3,`#141416`),a.addColorStop(1,`#2c2c30`),e.fillStyle=a,e.beginPath(),e.roundRect(t-i,n-i,r,r,2),e.fill();let o=e.createLinearGradient(t-3.5,0,t+3.5,0);o.addColorStop(0,`#4b5563`),o.addColorStop(.5,`#d1d5db`),o.addColorStop(1,`#4b5563`),e.fillStyle=o,e.fillRect(t-3.5,n-i+2.5,7,r-5),e.fillStyle=`#09090a`,e.fillRect(t-.75,n-i+2,1.5,r-4)}function g(e,t,n,r){let i=r/2;e.fillStyle=`#8080ff`,e.fillRect(t-i-2,n-i-2,r+4,r+4),e.fillStyle=`#b080ff`,e.beginPath(),e.moveTo(t-i,n-i),e.lineTo(t-i+3,n-i+3),e.lineTo(t-i+3,n+i-3),e.lineTo(t-i,n+i),e.closePath(),e.fill(),e.fillStyle=`#5080ff`,e.beginPath(),e.moveTo(t+i,n-i),e.lineTo(t+i-3,n-i+3),e.lineTo(t+i-3,n+i-3),e.lineTo(t+i,n+i),e.closePath(),e.fill(),e.fillStyle=`#8050ff`,e.beginPath(),e.moveTo(t-i,n-i),e.lineTo(t-i+3,n-i+3),e.lineTo(t+i-3,n-i+3),e.lineTo(t+i,n-i),e.closePath(),e.fill(),e.fillStyle=`#80b0ff`,e.beginPath(),e.moveTo(t-i,n+i),e.lineTo(t-i+3,n+i-3),e.lineTo(t+i-3,n+i-3),e.lineTo(t+i,n+i),e.closePath(),e.fill()}for(let t=0;t<e;t++)for(let e=0;e<14;e++){let n=e===0||e===1||e===12||e===13,r=t%6==5;if(n&&r)continue;let i=sm(t*14+e),o=u(i.x,i.z);h(a,o.x,o.y,14),g(s,o.x,o.y,14)}return a.font=`bold 13px monospace`,a.fillStyle=`#64748b`,a.textAlign=`center`,a.textBaseline=`middle`,(e===30?[1,5,10,15,20,25,30]:[1,5,10,15,20,25,30,35,40,45,50,55,60,63]).forEach(e=>{let t=u(sm((e-1)*14+2).x,0);a.fillText(e.toString(),t.x,u(0,-.94).y),a.fillText(e.toString(),t.x,u(0,-.12).y),a.fillText(e.toString(),t.x,u(0,.12).y),a.fillText(e.toString(),t.x,u(0,.94).y)}),a.font=`bold 15px sans-serif`,a.fillStyle=`#475569`,[`A`,`B`,`C`,`D`,`E`,`F`,`G`,`H`,`I`,`J`].forEach((t,n)=>{let r=u(0,sm(n+2).z);a.textAlign=`left`,a.fillText(t,u(-l+.08,0).x,r.y),a.textAlign=`center`,a.fillText(t,u(om[Math.floor(e/2)],0).x,r.y),a.textAlign=`right`,a.fillText(t,u(l-.08,0).x,r.y)}),a.fillStyle=`#0f172a`,a.font=`bold italic 22px sans-serif`,a.textAlign=`left`,a.fillText(`CircuitIQ`,60,u(0,0).y-4),a.fillStyle=`#64748b`,a.font=`bold 10px sans-serif`,a.fillText(e===30?`3D BREADBOARD MODEL 30-T`:`3D BREADBOARD MODEL 63-T`,60,u(0,0).y+14),a.textAlign=`right`,a.fillStyle=`#64748b`,a.fillText(`INTEGRATED BUS TERMINALS`,n-60,u(0,0).y-4),a.fillText(`MADE IN CIRCUIT-IQ LABS`,n-60,u(0,0).y+10),{canvas:i,normCanvas:o}}function um(e,t,n,r,i=8){let a=new qa,o=e/2-r,s=n/2-r;a.moveTo(-o,-s),a.lineTo(o,-s),a.quadraticCurveTo(o+r,-s,o+r,-s+r),a.lineTo(o+r,s-r),a.quadraticCurveTo(o+r,s+r,o,s+r),a.lineTo(-o,s+r),a.quadraticCurveTo(-o-r,s+r,-o-r,s-r),a.lineTo(-o-r,-s+r),a.quadraticCurveTo(-o-r,-s,-o,-s);let c=new Mo(a,{steps:1,depth:t-2*r,bevelEnabled:!0,bevelThickness:r,bevelSize:r,bevelOffset:-r,bevelSegments:i,curveSegments:i});return c.center(),c.rotateX(Math.PI/2),c}function dm(e,t,n,r,i=8){let a=new qa,o=e/2-r,s=n/2-r;a.moveTo(-o,-s),a.lineTo(o,-s),a.quadraticCurveTo(o+r,-s,o+r,-s+r),a.lineTo(o+r,s-r),a.quadraticCurveTo(o+r,s+r,o,s+r),a.lineTo(-o,s+r),a.quadraticCurveTo(-o-r,s+r,-o-r,s-r),a.lineTo(-o-r,-s+r),a.quadraticCurveTo(-o-r,-s,-o,-s);let c=new Mo(a,{steps:1,depth:t-2*r,bevelEnabled:!0,bevelThickness:r,bevelSize:r,bevelOffset:-r,bevelSegments:i,curveSegments:i});return c.center(),c.rotateX(Math.PI/2),c}function fm(e){let t=new jn,n=new U(new G(.065,.065,.05,16),new K({color:e,roughness:.5,metalness:.2}));n.position.y=.025,n.castShadow=!0,n.receiveShadow=!0,t.add(n);let r=new G(.05,.05,.02,16),i=new K({color:13751771,metalness:.95,roughness:.1}),a=new U(r,i);a.position.y=.06,a.castShadow=!0,t.add(a);let o=new U(new G(.058,.052,.06,16),i);o.position.y=.1,o.castShadow=!0,t.add(o);let s=new U(new G(.02,.02,.15,8),i);return s.position.y=.075,t.add(s),t}function pm(e){Y.boardType=e,tm=e===`half`?30:63;let t=.1522,n=-(tm-1)*t/2;om=Array.from({length:tm},(e,r)=>n+r*t),Y.placedComponents.forEach(e=>{Z.remove(e.mesh),e.leads.forEach(e=>Z.remove(e))}),Y.placedComponents=[],Y.wires.forEach(e=>{Z.remove(e.lineMesh),e.electrons.forEach(e=>Z.remove(e)),e.pins&&e.pins.forEach(e=>Z.remove(e)),e.sleeves&&e.sleeves.forEach(e=>Z.remove(e))}),Y.wires=[],Y.isRunning=!1,np(),Yf(!1),Gp&&=(Z.remove(Gp),null),nm&&Z.remove(nm),nm=new jn;let r=tm===30?5:10,i=new U(um(r+1,.08,4.4,.08),new K({color:1003826,roughness:.35,metalness:.25}));i.position.y=-.16,i.castShadow=!0,i.receiveShadow=!0,nm.add(i);let a=new U(um(r+.8,.005,4.2,.06),new K({color:13938487,roughness:.1,metalness:.9}));a.position.y=-.115,nm.add(a);let o=new U(new W(r,.25,3.64),new Jr({visible:!1}));o.position.y=-.045,nm.add(o),Up=o;let s=lm(tm,r),c=new ca(s.canvas);c.colorSpace=He;let l=new ca(s.normCanvas),u=new K({color:16316664,roughness:.45,metalness:.1}),d=[new K({map:c,normalMap:l,normalScale:new z(1.5,1.5),roughness:.55,metalness:.15}),u],f=dm(r,.2,3.64,.05);f.computeVertexNormals();let p=f.attributes.position,m=f.attributes.uv;if(p&&m){for(let e=0;e<p.count;e++){let t=p.getX(e),n=p.getZ(e),i=(t+r/2)/r,a=(n+1.82)/3.64;m.setXY(e,i,a)}m.needsUpdate=!0}let h=new U(f,d);h.position.set(0,-.02,0),h.castShadow=!0,h.receiveShadow=!0,nm.add(h),Wp=h;let g=new U(um(r+.1,.02,3.74,.05),new K({color:14078929,roughness:.9}));g.position.set(0,-.13,0),g.castShadow=!0,g.receiveShadow=!0,nm.add(g);let _=new U(new W(r,.05,.04),new K({color:1976635,roughness:.9}));_.position.set(0,.055,0),nm.add(_),Z.add(nm);let v=document.getElementById(`inspector-bb-type`),y=document.getElementById(`inspector-bb-size`);v&&(v.innerText=e===`half`?`Half-size (400pt)`:`Full-size (830pt)`),y&&(y.innerText=e===`half`?`80.5×8.5×54.5mm`:`165×8.5×54.5mm`),pp(Y.activeExperiment)}function mm(e){pm(e)}function hm(){try{let e=document.getElementById(`canvas-3d-parent`),n=e.clientWidth||600,r=e.clientHeight||450;Z=new Bn,Z.background=new H(461331),Z.fog=new zn(461331,.04),Vp=new Us(40,n/r,.1,100),Vp.position.set(0,7.5,9),Vp.lookAt(0,0,0);try{Hp=new zd({antialias:!0,powerPreference:`high-performance`})}catch(e){console.warn(`Failed to create WebGLRenderer with antialias, trying without antialias...`,e);try{Hp=new zd({antialias:!1})}catch{throw Error(`WebGL context creation failed. This usually happens when you have too many tabs of Circuit IQ open in your browser. Please close other tabs and reload this page.`)}}Hp.setSize(n,r),Hp.setPixelRatio(Math.min(window.devicePixelRatio,2)),Hp.shadowMap.enabled=!0,e.appendChild(Hp.domElement),Z.add(new Zs(16777215,2));let i=new Xs(16777215,3);i.position.set(3,12,4),i.castShadow=!0,i.shadow.mapSize.width=2048,i.shadow.mapSize.height=2048,i.shadow.camera.near=.5,i.shadow.camera.far=25,i.shadow.camera.left=-8,i.shadow.camera.right=8,i.shadow.camera.top=8,i.shadow.camera.bottom=-8,i.shadow.bias=-5e-4,Z.add(i);let a=new Gs(11032055,45,25,Math.PI/4,.5,1.2);a.position.set(-6,6,2),Z.add(a);let o=new Gs(6514417,35,25,Math.PI/4,.5,1.2);o.position.set(6,6,-2),Z.add(o);let s=new U(new Fo(60,60),new K({color:790036,roughness:.35,metalness:.6}));s.rotation.x=-Math.PI/2,s.position.y=-.22,s.receiveShadow=!0,Z.add(s);let c=new xc(40,40,53380,1580585);c.position.y=-.219,c.material.opacity=.15,c.material.transparent=!0,Z.add(c),pm(`full`),Kp=new U(new Io(.04,.06,4),new Jr({color:15381256,side:2})),Kp.rotation.set(-Math.PI/2,0,Math.PI/4),Kp.position.set(0,-10,0),Z.add(Kp),qp=cm(),qp.position.set(0,.05,-3.2),qp.visible=!1,Z.add(qp);let l=new Io(.06,.09,32),u=new Jr({color:2278750,side:2});Q=new U(l,u),Q.rotation.x=-Math.PI/2,Q.position.set(0,-10,0),Z.add(Q),$=new U(l,u),$.rotation.x=-Math.PI/2,$.position.set(0,-10,0),Z.add($),Cm();let d=new Ss;d.onStart=(e,t,n)=>{window.parent.postMessage({type:`lab-loading`,progress:0},`*`)},d.onProgress=(e,t,n)=>{let r=Math.round(t/n*100);window.parent.postMessage({type:`lab-loading`,progress:r},`*`)},d.onLoad=()=>{window.parent.postMessage({type:`lab-loaded`},`*`)},d.onError=e=>{console.error(`Error loading resource:`,e)},Kf=new As(d).load(`/DefaultMaterial_baseColor.jpg`),Kf.wrapS=t,Kf.wrapT=t,Kf.flipY=!1;let f=new Ud(d);f.load(`/models/resistor/scene.gltf`,e=>{Wf=e.scene,Wf.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.name===`METAL-material`&&(e.visible=!1))}),Rm()},void 0,e=>{console.error(`Failed to load resistor GLTF model`,e)}),f.load(`/models/electronic_components/scene.gltf`,e=>{Gf=e.scene,Gf.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),console.log(`Successfully loaded electronic components model`,Gf),Y.placedComponents&&Y.placedComponents.length>0&&Y.placedComponents.forEach(e=>{if(e.type===`wire`||e.type===`eraser`)return;Z.remove(e.mesh),e.leads.forEach(e=>Z.remove(e));let{mesh:t,leads:n}=Vm(e.type,e.snap1,e.snap2,e.color);e.mesh=t,e.leads=n,Z.add(t),n.forEach(e=>Z.add(e))})},void 0,e=>{console.error(`Failed to load electronic components GLTF model`,e)}),Mm=!1;let p=0,m=0,h={x:0,y:0};function g(e){switch(e){case`resistor`:case`capacitor`:return{colSpan:5,rowSpan:0};case`ammeter`:case`voltmeter`:return{colSpan:4,rowSpan:0};case`inductor`:case`diode`:return{colSpan:4,rowSpan:0};case`led`:case`transistor`:return{colSpan:2,rowSpan:0};case`button`:case`toggle_switch`:return{colSpan:0,rowSpan:1};case`display`:return{colSpan:4,rowSpan:1};case`source`:return{colSpan:0,rowSpan:1};default:return{colSpan:4,rowSpan:0}}}e.addEventListener(`dragover`,e=>{if(e.preventDefault(),!Y.draggingSidebarTool)return;let t=Hp.domElement.getBoundingClientRect();Dm.x=(e.clientX-t.left)/t.width*2-1,Dm.y=-((e.clientY-t.top)/t.height)*2+1,Em.setFromCamera(Dm,Vp);let n=Em.intersectObject(Up);if(n.length>0){let e=n[0].point,t=Up.worldToLocal(e.clone()),r=-(tm-1)*.1522/2,i=Math.round((t.x-r)/.1522);i=Math.max(0,Math.min(tm-1,i));let a=0,o=1/0;for(let e=0;e<14;e++){let n=0;e===0?n=-1.296:e===1?n=-1.144:e>=2&&e<=6?n=-.839+(e-2)*.1522:e>=7&&e<=11?n=.229+(e-7)*.1522:e===12?n=1.144:e===13&&(n=1.296);let r=Math.abs(t.z-n);r<o&&(o=r,a=e)}let s=a===0||a===1||a===12||a===13,c=i%6==5;if(s&&c){Y.ghostMesh&&=(Z.remove(Y.ghostMesh),null),Y.ghostSnap1=null,Y.ghostSnap2=null;return}let l=i*14+a,u=Y.draggingSidebarTool,d=g(u),f=Math.min(tm-1,i+d.colSpan),p=Math.min(13,a+d.rowSpan),m=f*14+p;if(Y.ghostSnap1!==l||Y.ghostSnap2!==m){Y.ghostSnap1=l,Y.ghostSnap2=m,Y.ghostMesh&&=(Z.remove(Y.ghostMesh),null);let e=Vm(u,l,m,u===`led`?Y.params.led_color||`red`:null),t=new jn;t.add(e.mesh),e.leads.forEach(e=>t.add(e)),t.traverse(e=>{e.isMesh&&(e.material=e.material.clone(),e.material.transparent=!0,e.material.opacity=.55,e.castShadow=!1,e.receiveShadow=!1)}),Y.ghostMesh=t,Z.add(Y.ghostMesh)}}else Y.ghostMesh&&=(Z.remove(Y.ghostMesh),null),Y.ghostSnap1=null,Y.ghostSnap2=null}),e.addEventListener(`dragleave`,()=>{Y.ghostMesh&&=(Z.remove(Y.ghostMesh),null),Y.ghostSnap1=null,Y.ghostSnap2=null}),e.addEventListener(`drop`,e=>{if(e.preventDefault(),!Y.draggingSidebarTool)return;let t=Y.draggingSidebarTool,n=Y.ghostSnap1,r=Y.ghostSnap2;Y.ghostMesh&&=(Z.remove(Y.ghostMesh),null),Y.ghostSnap1=null,Y.ghostSnap2=null,Y.draggingSidebarTool=null,n!==null&&r!==null&&n!==r&&(t===`wire`?Zm(n,r):t===`eraser`||Hm(t,n,r)),document.querySelectorAll(`.comp-chip:not([data-type^="bb_"])`).forEach(e=>e.classList.remove(`selected`)),Y.selectedTool=null,wp()}),e.addEventListener(`mousedown`,e=>{let t=Hp.domElement.getBoundingClientRect();Dm.x=(e.clientX-t.left)/t.width*2-1,Dm.y=-((e.clientY-t.top)/t.height)*2+1,Em.setFromCamera(Dm,Vp);let n=Em.intersectObjects(Z.children,!0).find(e=>e.object.name===`plunger`);if(n){let e=Y.placedComponents.find(e=>{let t=!1;return e.mesh.traverse(e=>{e===n.object&&(t=!0)}),t});Y.activePressedPlunger=n.object;let t=Y.activePressedPlunger.userData.originalY===void 0?.24:Y.activePressedPlunger.userData.originalY;e&&e.type===`button`?(Y.buttonPressed=!0,Y.activePressedPlunger.position.y=t-.05):(Y.buttonPressed=!Y.buttonPressed,Y.activePressedPlunger.position.y=Y.buttonPressed?t-.05:t),Mm=!1,wm();return}if(Y.selectedTool===`wire`&&Om!==null){Y.isDrawingWire=!0,Y.wireStartSnap=Om,Mm=!1;return}if(!Y.selectedTool){let e=Y.placedComponents.map(e=>e.mesh),t=Em.intersectObjects(e,!0);if(t.length>0){let e=t[0].object,n=-1;for(;e&&(n=Y.placedComponents.findIndex(t=>t.mesh===e),n===-1);)e=e.parent;if(n!==-1&&!(Y.placedComponents[n].type===`source`&&Y.activeExperiment===`arduino_led`)){Y.selectedComponentIdx=n,Y.selectedHoleIndex=null,Y.draggedComponentIdx=n,Y.isDraggingComponent=!0,Y.dragStartSnap1=Y.placedComponents[n].snap1,Y.dragStartSnap2=Y.placedComponents[n].snap2,Mm=!1,Nm(!0);let e=Pm(Y.placedComponents[n]);Y.placedComponents[n].mesh.add(e),Jm(),Y.wasRunningBeforeDrag=Y.isRunning,Y.isRunning&&(Y.isRunning=!1,np(),Yf(!1),X.btnRun&&(X.btnRun.style.display=`block`),X.btnStop&&(X.btnStop.style.display=`none`),X.statusDot&&(X.statusDot.style.background=`var(--accent)`),X.statusTextBar&&(X.statusTextBar.innerText=`READY`));return}}let n=[];Y.wires.forEach(e=>{e.pins&&n.push(e.pins[0],e.pins[1]),e.sleeves&&n.push(e.sleeves[0],e.sleeves[1])});let r=Em.intersectObjects(n);if(r.length>0){let e=r[0].object,t=-1,n=-1;for(let r=0;r<Y.wires.length;r++){let i=Y.wires[r];if(i.pins&&i.pins[0]===e||i.sleeves&&i.sleeves[0]===e){t=r,n=0;break}else if(i.pins&&i.pins[1]===e||i.sleeves&&i.sleeves[1]===e){t=r,n=1;break}}if(t!==-1){Y.draggedWireIdx=t,Y.draggedWireEnd=n,Y.isDraggingWireEnd=!0,Y.dragStartWireHole=n===0?Y.wires[t].fromHole:Y.wires[t].toHole,Mm=!1,Y.wasRunningBeforeDrag=Y.isRunning,Y.isRunning&&(Y.isRunning=!1,np(),Yf(!1),X.btnRun&&(X.btnRun.style.display=`block`),X.btnStop&&(X.btnStop.style.display=`none`),X.statusDot&&(X.statusDot.style.background=`var(--accent)`),X.statusTextBar&&(X.statusTextBar.innerText=`READY`));return}}}Mm=!0,p=e.clientX,m=e.clientY,h={x:e.clientX,y:e.clientY}}),window.addEventListener(`mouseup`,e=>{if(Mm=!1,Y.activePressedPlunger){let e=Y.placedComponents.find(e=>{let t=!1;return e.mesh.traverse(e=>{e===Y.activePressedPlunger&&(t=!0)}),t});if(e&&e.type===`button`){Y.buttonPressed=!1;let e=Y.activePressedPlunger.userData.originalY===void 0?.24:Y.activePressedPlunger.userData.originalY;Y.activePressedPlunger.position.y=e,Y.activePressedPlunger=null,wm()}else Y.activePressedPlunger=null}if(Y.isDrawingWire){Y.isDrawingWire=!1,Y.tempWireMesh&&=(Z.remove(Y.tempWireMesh),null),Y.wireStartSnap!==null&&Om!==null&&Y.wireStartSnap!==Om&&Zm(Y.wireStartSnap,Om),Y.wireStartSnap=null,Y.selectedTool=null,document.querySelectorAll(`.comp-chip:not([data-type^="bb_"])`).forEach(e=>e.classList.remove(`selected`)),wp();return}if(Y.isDraggingComponent){if(Y.isDraggingComponent=!1,Om===null&&Y.draggedComponentIdx!==-1){let e=Y.placedComponents[Y.draggedComponentIdx];Z.remove(e.mesh),e.leads.forEach(e=>Z.remove(e));let t=Vm(e.type,Y.dragStartSnap1,Y.dragStartSnap2,e.color);e.mesh=t.mesh,e.leads=t.leads,e.snap1=Y.dragStartSnap1,e.snap2=Y.dragStartSnap2,Z.add(e.mesh),e.leads.forEach(e=>Z.add(e))}Nm(),Y.draggedComponentIdx=-1,Y.dragStartSnap1=null,Y.dragStartSnap2=null;let e=$f();e.status===`success`?(Y.wasRunningBeforeDrag?(Y.isRunning=!0,tp(),Yf(!0),X.btnRun&&(X.btnRun.style.display=`none`),X.btnStop&&(X.btnStop.style.display=`block`),X.statusDot&&(X.statusDot.style.background=`var(--red)`),X.statusTextBar&&(X.statusTextBar.innerText=`RUNNING`)):wm(),op(`Circuit IQ · AI Mentor`,`Circuit validated: `+e.message)):(Y.isRunning=!1,np(),Yf(!1),X.btnRun&&(X.btnRun.style.display=`block`),X.btnStop&&(X.btnStop.style.display=`none`),X.statusDot&&(X.statusDot.style.background=`var(--accent)`),X.statusTextBar&&(X.statusTextBar.innerText=`READY`),op(`Circuit IQ · AI Mentor`,`Validation Failure: `+e.message)),vp(),Bp(),Rp();return}if(Y.isDraggingWireEnd){if(Y.isDraggingWireEnd=!1,Y.draggedWireIdx!==-1){let e=Y.wires[Y.draggedWireIdx],t=Y.draggedWireEnd===0?e.toHole:e.fromHole;if(Om===null||Om===t){let t=e.fromHole,n=e.toHole;Y.draggedWireEnd===0?t=Y.dragStartWireHole:n=Y.dragStartWireHole,Xm(Y.draggedWireIdx,t,n)}}Y.draggedWireIdx=-1,Y.draggedWireEnd=-1,Y.dragStartWireHole=null;let e=$f();e.status===`success`?(Y.wasRunningBeforeDrag?(Y.isRunning=!0,tp(),Yf(!0),X.btnRun&&(X.btnRun.style.display=`none`),X.btnStop&&(X.btnStop.style.display=`block`),X.statusDot&&(X.statusDot.style.background=`var(--red)`),X.statusTextBar&&(X.statusTextBar.innerText=`RUNNING`)):wm(),op(`Circuit IQ · AI Mentor`,`Circuit validated: `+e.message)):(Y.isRunning=!1,np(),Yf(!1),X.btnRun&&(X.btnRun.style.display=`block`),X.btnStop&&(X.btnStop.style.display=`none`),X.statusDot&&(X.statusDot.style.background=`var(--accent)`),X.statusTextBar&&(X.statusTextBar.innerText=`READY`),op(`Circuit IQ · AI Mentor`,`Validation Failure: `+e.message)),vp(),Bp(),Rp();return}Math.hypot(e.clientX-h.x,e.clientY-h.y)<5&&Im()}),e.addEventListener(`mousemove`,e=>{let t=Hp.domElement.getBoundingClientRect();if(Dm.x=(e.clientX-t.left)/t.width*2-1,Dm.y=-((e.clientY-t.top)/t.height)*2+1,km=e.clientX,Am=e.clientY,Mm){let t=e.clientX-p,n=e.clientY-m;rm+=t*.005,im+=n*.005,im=Math.max(.1,Math.min(Math.PI/2-.02,im)),p=e.clientX,m=e.clientY}if(Fm(),Y.isDrawingWire&&Y.wireStartSnap!==null&&(Y.tempWireMesh&&=(Z.remove(Y.tempWireMesh),null),Om!==null&&Om!==Y.wireStartSnap)){let e=sm(Y.wireStartSnap),t=sm(Om);Y.tempWireMesh=new U(new zo(Ym(e.clone().add(new B(0,.28,0)),t.clone().add(new B(0,.28,0)),Y.wires.length),64,.024,8,!1),new K({color:2278750,roughness:.5,transparent:!0,opacity:.85})),Z.add(Y.tempWireMesh)}if(Y.isDraggingComponent&&Y.draggedComponentIdx!==-1&&Om!==null){let e=Y.placedComponents[Y.draggedComponentIdx],t=Math.floor(Y.dragStartSnap1/14),n=Y.dragStartSnap1%14,r=Math.floor(Y.dragStartSnap2/14),i=Y.dragStartSnap2%14,a=r-t,o=i-n,s=Math.floor(Om/14),c=Om%14,l=Math.max(0,Math.min(tm-1,s+a)),u=Math.max(0,Math.min(13,c+o)),d=s*14+c,f=l*14+u;if(d!==e.snap1||f!==e.snap2){Z.remove(e.mesh),e.leads.forEach(e=>Z.remove(e));let t=Vm(e.type,d,f,e.color);e.mesh=t.mesh,e.leads=t.leads,e.snap1=d,e.snap2=f,Z.add(e.mesh),e.leads.forEach(e=>Z.add(e)),Nm(),Zp=Pm(e),e.mesh.add(Zp)}}if(Y.isDraggingWireEnd&&Y.draggedWireIdx!==-1&&Om!==null){let e=Y.wires[Y.draggedWireIdx],t=e.fromHole,n=e.toHole,r=t,i=n;Y.draggedWireEnd===0?r=Om:i=Om,r!==i&&(r!==t||i!==n)&&Xm(Y.draggedWireIdx,r,i)}});function _(){if(requestAnimationFrame(_),Z.rotation.y+=(rm-Z.rotation.y)*.08,em+=($p-em)*.15,am+=(im-am)*.1,Vp.position.set(0,em*Math.sin(am),em*Math.cos(am)),X.zoomDisplay&&(X.zoomDisplay.innerText=Math.round(11.715/em*100)+`%`),Q&&$){let e=1+.18*Math.sin(Date.now()*.008);Q.scale.set(e,e,1),$.scale.set(e,e,1)}if(Lp(),Jf){let e=Y.meters.amps||0,t=Math.max(.002,Math.min(.08,.005+.1*e));qf+=t,qf>1&&(qf=0),Y.wires.forEach(t=>{if(t.lineMesh&&t.lineMesh.material){t.lineMesh.material.emissive.setHex(t.lineMesh.material.color.getHex());let n=Math.max(0,Math.min(1.8,e*8));t.lineMesh.material.emissiveIntensity=n*(.8+.2*Math.sin(Date.now()*.015))}t.electrons.forEach((e,n)=>{let r=(qf+n/t.electrons.length)%1,i=t.curve.getPointAt(r);e.position.copy(i),e.visible=!0})})}else Y.wires.forEach(e=>{e.lineMesh&&e.lineMesh.material&&(e.lineMesh.material.emissive.setHex(0),e.lineMesh.material.emissiveIntensity=0),e.electrons.forEach(e=>{e.visible=!1})});if(Y.proceduralGroup){if([`snell`,`lens_eq`,`tir`,`prism`].includes(Y.activeExperiment)){let e=Y.proceduralGroup.getObjectByName(`laser-ray`);if(e){let t=Y.params.C||45,n=Y.params.V||1,r=Y.params.R||1.5,i=[new B(-2.5,.4,0),new B(0,.4,0)];if(Y.activeExperiment===`snell`){let e=n/r*Math.sin(t*Math.PI/180);if(e<=1){let t=new B(2.5,.4-2.5*Math.tan(Math.asin(e)),0);i.push(t)}else{let e=new B(-2.5,.4+2.5*Math.tan(t*Math.PI/180),0);i.push(e)}}else if(Y.activeExperiment===`tir`){let e=n/r*Math.sin(t*Math.PI/180);if(e>1){let e=new B(-2.5,.4+2.5*Math.tan(t*Math.PI/180),0);i.push(e)}else{let t=new B(2.5,.4-2.5*Math.tan(Math.asin(e)),0);i.push(t)}}else if(Y.activeExperiment===`prism`){let e=new B(.5,.25,0),t=new B(2.5,.05,0);i.push(e,t)}else if(Y.activeExperiment===`lens_eq`){let e=Y.meters.amps,t=Y.params.V||30,n=new B(Math.min(2.5,e*.05),e>0?.2:.6,0);i.push(n);let r=Y.proceduralGroup.getObjectByName(`lens-object-pin`),a=Y.proceduralGroup.getObjectByName(`lens-image-screen`),o=Y.proceduralGroup.getObjectByName(`lens-screen-stand`);r&&(r.position.x=-t*.05),a&&(a.position.x=Math.min(2.5,e*.05)),o&&(o.position.x=Math.min(2.5,e*.05))}e.geometry.setFromPoints(i)}}else if(Y.activeExperiment===`pendulum`){let e=Y.proceduralGroup.getObjectByName(`pendulum-pivot`);if(e){let t=Y.params.V||30,n=Y.params.R||1.5,r=Y.params.L||9.8,i=Math.sqrt(r/n),a=t*Math.PI/180*Math.cos(Date.now()*.001*i);e.rotation.z=a;let o=e.getObjectByName(`pendulum-string`),s=e.getObjectByName(`pendulum-bob`);o&&s&&(o.scale.y=n/1.4,o.position.y=-n/2,s.position.y=-n)}}else if(Y.activeExperiment===`hooke`){let e=Y.proceduralGroup.getObjectByName(`spring-group`),t=Y.proceduralGroup.getObjectByName(`spring-weight`);if(e&&t){let n=Y.params.V*.001,r=Y.params.R||25,i=-1.3-n*9.8/r*.5;for(t.position.y=3.1+i-.12;e.children.length>0;)e.remove(e.children[0]);let a=[],o=.08;for(let e=0;e<=180;e++){let t=e/180,n=t*18*Math.PI*2,r=o*Math.cos(n),s=o*Math.sin(n),c=t*i;a.push(new B(r,c,s))}let s=new Ji(new Pr().setFromPoints(a),new Bi({color:9741240}));e.add(s)}}else if(Y.activeExperiment===`projectile`){let e=Y.proceduralGroup.getObjectByName(`projectile-ball`),t=Y.proceduralGroup.getObjectByName(`cannon-group`);if(t){let e=Y.params.V||45;t.children[0].rotation.z=e*Math.PI/180}if(e&&Y.isRunning){e.visible=!0;let t=Y.params.V*Math.PI/180,n=Y.params.R,r=Y.params.L||9.8,i=(Date.now()-Y.simStartTime)*.001*2,a=n*i*Math.cos(t),o=n*i*Math.sin(t)-.5*r*i*i;o>=0?e.position.set(-4+a*.2,.2+o*.2,0):e.position.set(-4+n*n*Math.sin(2*t)/r*.2,.2,0)}else e&&(e.visible=!1)}else if([`ideal_gas`,`boyle`,`charles`].includes(Y.activeExperiment)){let e=Y.proceduralGroup.getObjectByName(`piston-plate`),t=Y.meters.amps,n=Y.meters.ohms;if(e&&(e.position.y=.2+t/30*1.6),Y.moleculesData&&Y.isRunning){let t=Math.sqrt(n/300)*.8;Y.moleculesData.forEach(n=>{n.mesh.position.x+=n.vx*t,n.mesh.position.y+=n.vy*t,n.mesh.position.z+=n.vz*t;let r=e?e.position.y-.08:1.8;n.mesh.position.y<.05&&(n.mesh.position.y=.05,n.vy=-n.vy),n.mesh.position.y>r&&(n.mesh.position.y=r,n.vy=-n.vy);let i=Math.sqrt(n.mesh.position.x*n.mesh.position.x+n.mesh.position.z*n.mesh.position.z);if(i>.54){let e=n.mesh.position.x/i,t=n.mesh.position.z/i,r=n.vx*e+n.vz*t;n.vx-=2*r*e,n.vz-=2*r*t,n.mesh.position.x=.53*e,n.mesh.position.z=.53*t}})}}else if(Y.activeExperiment===`photoelectric`){let e=Y.proceduralGroup.getObjectByName(`photoelectrons`);if(e&&Y.isRunning){let t=Y.params.V||8,n=Y.params.L||2.2;if(t*.4135>n&&Math.random()<.12&&e.children.length<25){let r=new U(new Lo(.02,8,8),new Jr({color:16436245}));r.position.set(-1,.5+(Math.random()-.5)*.3,(Math.random()-.5)*.3),r.userData={speed:.02+(t*.4135-n)*.015},e.add(r)}for(let t=e.children.length-1;t>=0;t--){let n=e.children[t];n.position.x+=n.userData.speed,n.position.x>1&&e.remove(n)}}}else if(Y.activeExperiment===`bohr_model`){let e=Y.proceduralGroup.getObjectByName(`bohr-electron`);if(e){let t=Y.params.V||3,n=t*.6,r=Date.now()*.002*(1/(t*t));e.position.set(n*Math.cos(r),.5,n*Math.sin(r))}}else if(Y.activeExperiment===`radioactive`&&Y.isRunning){let e=Y.params.R||10,t=Math.LN2/e*.016;Y.decayList&&Y.decayList.forEach(e=>{!e.decayed&&Math.random()<t&&(e.decayed=!0,e.mesh.material=new K({color:3900150,roughness:.8}))})}else if([`faraday`,`lenz`].includes(Y.activeExperiment)){let e=Y.proceduralGroup.getObjectByName(`faraday-magnet`);if(e){let t=Y.params.V||2,n=Date.now()*.002*t;e.position.x=2*Math.sin(n)}}else if(Y.activeExperiment===`solenoid`){let e=Y.proceduralGroup.getObjectByName(`solenoid-fields`);e&&Y.isRunning&&e.children.forEach((e,t)=>{e.material.opacity=.1+.4*Math.abs(Math.sin(Date.now()*.003+t))})}else if(Y.activeExperiment===`doppler`){let e=Y.proceduralGroup.getObjectByName(`doppler-source`),t=Y.proceduralGroup.getObjectByName(`doppler-ripples`);if(e&&t){let n=Y.params.V||50;Y.params.R;let r=Y.params.L||340,i=-4+Date.now()*.001*n*.05%8;if(e.position.x=i,Y.lastDopplerRippleTime||=0,Date.now()-Y.lastDopplerRippleTime>300){Y.lastDopplerRippleTime=Date.now();let e=new U(new Io(.05,.07,32),new Jr({color:3900150,transparent:!0,opacity:.8,side:2}));e.rotation.x=Math.PI/2,e.position.set(i,.25,0),e.userData={radius:.06,originX:i,timeCreated:Date.now()},t.add(e)}for(let e=t.children.length-1;e>=0;e--){let n=t.children[e],i=(Date.now()-n.userData.timeCreated)*.001,a=r*.008*i;n.scale.set(a,a,1),n.material.opacity=Math.max(0,.8*(1-i/2)),i>2&&t.remove(n)}}}else if(Y.activeExperiment===`specific_heat`&&Y.isRunning){let e=Y.proceduralGroup.getObjectByName(`specific-heat-metal`),t=Y.proceduralGroup.getObjectByName(`specific-heat-water`);if(e){Y.simStartTime||=Date.now();let n=(Date.now()-Y.simStartTime)*.001;if(n<2){let t=n/2;e.position.x=.8-1.6*t,e.position.y=.74+.5*Math.sin(t*Math.PI)-.3*t}else{if(e.position.set(-.8,.25,0),t){let e=Math.min(1,(n-2)/3);t.material.color.setRGB(.23+.7*e,.51*(1-e),.96*(1-e))}let r=Y.params.R,i=Y.meters.ohms,a=Math.max(0,1-(n-2)/3),o=i+(r-i)*a,s=new H().setHSL(0,1,.2+o/100*.3);e.material.color.copy(s)}}}else if(Y.activeExperiment===`de_broglie`&&Y.isRunning){if(Y.lastBroglieTime||=0,Y.broglieParticles||=[],Date.now()-Y.lastBroglieTime>200){Y.lastBroglieTime=Date.now();let e=new U(new Lo(.04,8,8),new Jr({color:3718648}));e.position.set(-2,.5,(Math.random()-.5)*.2),e.userData={phase:0,speed:.06},Y.proceduralGroup.add(e),Y.broglieParticles.push(e)}for(let e=Y.broglieParticles.length-1;e>=0;e--){let t=Y.broglieParticles[e];if(t.position.x+=t.userData.speed,t.position.y=.5+.15*Math.sin(t.position.x*12-Date.now()*.01),t.position.x>-.5&&t.position.x-t.userData.speed<=-.5&&(t.position.z=Math.random()>.5?.35:-.35),t.position.x>1.8){Y.proceduralGroup.remove(t),Y.broglieParticles.splice(e,1);let n=new U(new Lo(.03,8,8),new Jr({color:3462041})),r=0,i=Math.random();r=i<.4?(Math.random()-.5)*.3:i<.7?.7+(Math.random()-.5)*.3:i<.9?-.7-(Math.random()-.5)*.3:(Math.random()-.5)*1.8,n.position.set(1.78,.5+(Math.random()-.5)*.6,r),Y.proceduralGroup.add(n),setTimeout(()=>{Y.proceduralGroup.remove(n)},1200)}}}}Hp.render(Z,Vp)}_(),Rp(),e.addEventListener(`wheel`,e=>{e.preventDefault(),$p+=e.deltaY*.005,$p=Math.max(4,Math.min(20,$p))},{passive:!1});let v=document.getElementById(`cb-zoom-in`),y=document.getElementById(`cb-zoom-out`),b=document.getElementById(`cb-fit`);v&&v.addEventListener(`click`,()=>{$p=Math.max(4,$p-1.5)}),y&&y.addEventListener(`click`,()=>{$p=Math.min(20,$p+1.5)}),b&&b.addEventListener(`click`,()=>{$p=11.715}),window.addEventListener(`resize`,()=>{let t=e.clientWidth,n=e.clientHeight;Vp.aspect=t/n,Vp.updateProjectionMatrix(),Hp.setSize(t,n)})}catch(e){console.error(`ThreeJS Initialization Failed`,e);let t=document.createElement(`div`);t.style.position=`fixed`,t.style.top=`20px`,t.style.left=`20px`,t.style.background=`rgba(220, 38, 38, 0.95)`,t.style.color=`white`,t.style.padding=`15px`,t.style.borderRadius=`8px`,t.style.zIndex=`99999`,t.style.fontFamily=`monospace`,t.style.fontSize=`12px`,t.innerText=`ThreeJS Error: ${e.message}\nStack: ${e.stack}`,document.body.appendChild(t),window.parent.postMessage({type:`lab-loaded`},`*`)}}var gm,_m,vm,ym,bm,xm,Sm;function Cm(){let e=new jn;e.position.set(-1.8,.6,-3);let t=new U(um(1.6,1.2,.8,.08),new K({color:3359061,roughness:.3}));t.castShadow=!0,e.add(t);let n=new U(new W(1.5,1.1,.05),new K({color:1976635,roughness:.6}));n.position.set(0,0,.385),e.add(n),gm=document.createElement(`canvas`),gm.width=128,gm.height=64,_m=new ca(gm);let r=new Fo(1.1,.45);vm=new U(r,new Jr({map:_m})),vm.position.set(0,.25,.41),e.add(vm);let i=new U(r,new K({color:16777215,transparent:!0,opacity:.15,roughness:.05,metalness:.9}));i.position.set(0,.25,.415),e.add(i);let a=new K({color:988970,metalness:.3,roughness:.4}),o=new G(.12,.12,.06,16),s=new U(o,a);s.rotation.x=Math.PI/2,s.position.set(-.4,-.22,.41),e.add(s);let c=new U(o,a);c.rotation.x=Math.PI/2,c.position.set(.4,-.22,.41),e.add(c);let l=fm(15680580);l.rotation.x=Math.PI/2,l.position.set(-.4,-.42,.41),e.add(l);let u=fm(1976635);u.rotation.x=Math.PI/2,u.position.set(.4,-.42,.41),e.add(u),Z.add(e),ym=document.createElement(`canvas`),ym.width=256,ym.height=128,bm=new ca(ym),bm.colorSpace=He,xm=document.createElement(`canvas`),xm.width=256,xm.height=128,Sm=new ca(xm),Sm.colorSpace=He}async function wm(){if(Y.isRunning)try{let e;if(Y.activeExperiment!==`arduino_led`)try{let t=await fetch(`/api/calculate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({params:Y.params,active_experiment:Y.activeExperiment,button_pressed:Y.buttonPressed})});if(t.ok)e=await t.json();else throw Error(`HTTP ${t.status}`)}catch(t){console.warn(`Backend calculation failed, falling back to local calculation.`,t),e=Qf(Y.params,Y.activeExperiment,Y.buttonPressed)}else e=Qf(Y.params,Y.activeExperiment,Y.buttonPressed);Y.meters.volts=e.V,Y.meters.amps=e.I,Y.meters.ohms=e.Z,Y.meters.power=e.P;let t=Date.now(),n=(t-Y.energyStartTime)/1e3;if(Y.energyStartTime=t,Y.meters.energy+=e.P*n,Y.analysis.XL=e.XL,Y.analysis.XC=e.XC,Y.analysis.phi=e.phi,Y.analysis.f0=e.f0,Y.activeExperiment===`arduino_led`&&Y.isRunning&&Y.buttonPressed&&Y.meters.amps>0){_p(6);let e=(Y.meters.amps*1e3).toFixed(1),t=(Y.meters.power*1e3).toFixed(1);X.conclusionText.innerHTML=`<b>Conclusion (Arduino LED Button Circuit):</b><br>
        ...
        Upon releasing the button, the circuit opened and the LED immediately turned OFF — verifying the Normally Open (NO) behaviour of a momentary tactile switch.`}rp(),Tm()}catch(e){console.error(`Single calculation trigger error`,e)}}function Tm(){if(!gm)return;let e=gm.getContext(`2d`);if(e.fillStyle=`#0f172a`,e.fillRect(0,0,128,64),e.fillStyle=`#10b981`,e.font=`bold 22px Courier New`,Y.activeExperiment===`arduino_led`?(e.fillText(`5.0V USB`,10,28),e.font=`14px Courier New`,e.fillText(`ARDUINO UNO`,10,48)):(e.fillText(`${Y.params.V.toFixed(1)}V DC`,10,28),e.font=`14px Courier New`,e.fillText(`${Y.params.f.toFixed(0)}Hz AC`,10,48)),_m.needsUpdate=!0,ym&&bm){let e=ym.getContext(`2d`);e.fillStyle=`#021a10`,e.fillRect(0,0,256,128),e.fillStyle=`rgba(16,185,129,0.04)`;for(let t=0;t<128;t+=4)e.fillRect(0,t,256,2);e.strokeStyle=`rgba(248,113,113,0.7)`,e.lineWidth=3,e.strokeRect(2,2,252,124),e.fillStyle=`rgba(248,113,113,0.6)`,e.font=`bold 14px Courier New`,e.textAlign=`center`,e.fillText(`VOLT`,256/2,22),e.strokeStyle=`rgba(248,113,113,0.3)`,e.lineWidth=1,e.beginPath(),e.moveTo(10,32),e.lineTo(246,32),e.stroke();let t=Y.isRunning?Y.meters.volts.toFixed(3):`0.000`;e.fillStyle=Y.isRunning?`#f87171`:`#4b5563`,e.font=`bold 38px Courier New`,e.textAlign=`right`,e.fillText(t,216,85),e.fillStyle=`rgba(248,113,113,0.8)`,e.font=`bold 20px Courier New`,e.textAlign=`left`,e.fillText(`V`,222,85),e.fillStyle=Y.isRunning?`rgba(34,197,94,0.8)`:`rgba(239,68,68,0.5)`,e.font=`11px Courier New`,e.textAlign=`center`,e.fillText(Y.isRunning?`● LIVE`:`○ READY`,256/2,118),bm.needsUpdate=!0}if(xm&&Sm){let e=xm.getContext(`2d`);e.fillStyle=`#020c1a`,e.fillRect(0,0,256,128),e.fillStyle=`rgba(96,165,250,0.04)`;for(let t=0;t<128;t+=4)e.fillRect(0,t,256,2);e.strokeStyle=`rgba(96,165,250,0.7)`,e.lineWidth=3,e.strokeRect(2,2,252,124),e.fillStyle=`rgba(96,165,250,0.6)`,e.font=`bold 14px Courier New`,e.textAlign=`center`,e.fillText(`AMPER`,256/2,22),e.strokeStyle=`rgba(96,165,250,0.3)`,e.lineWidth=1,e.beginPath(),e.moveTo(10,32),e.lineTo(246,32),e.stroke();let t,n;Y.isRunning?Y.meters.amps<.1?(t=(Y.meters.amps*1e3).toFixed(2),n=`mA`):(t=Y.meters.amps.toFixed(4),n=`A`):(t=`0.00`,n=`mA`),e.fillStyle=Y.isRunning?`#60a5fa`:`#4b5563`,e.font=`bold 38px Courier New`,e.textAlign=`right`,e.fillText(t,212,85),e.fillStyle=`rgba(96,165,250,0.8)`,e.font=`bold 18px Courier New`,e.textAlign=`left`,e.fillText(n,216,85),e.fillStyle=Y.isRunning?`rgba(34,197,94,0.8)`:`rgba(239,68,68,0.5)`,e.font=`11px Courier New`,e.textAlign=`center`,e.fillText(Y.isRunning?`● LIVE`:`○ READY`,256/2,118),Sm.needsUpdate=!0}Y.placedComponents.forEach(e=>{if(e.type===`led`&&e.mesh.userData.ledMat)if(Y.isRunning&&Y.meters.amps>0){let t=16720384,n=e.color||Y.params.led_color||`red`;if(n===`green`?t=65348:n===`yellow`?t=16768256:n===`blue`?t=30719:n===`white`&&(t=16777215),e.mesh.userData.ledMat.emissive.setHex(t),e.mesh.userData.ledMat.emissiveIntensity=10,e.mesh.userData.ledMat.color.setHex(t),e.mesh.userData.ledLight)e.mesh.userData.ledLight.color.setHex(t),e.mesh.userData.ledLight.intensity=6,e.mesh.userData.ledLight.position.copy(e.mesh.position),e.mesh.userData.ledLight.position.y+=.1;else{let n=new qs(t,6,1.2);n.position.copy(e.mesh.position),n.position.y+=.1,Z.add(n),e.mesh.userData.ledLight=n}}else e.mesh.userData.ledMat.emissive.setHex(0),e.mesh.userData.ledMat.emissiveIntensity=0,e.mesh.userData.ledLight&&(e.mesh.userData.ledLight.intensity=0);if(e.type===`source`&&e.mesh.userData.powerButton&&(e.mesh.userData.powerButton.material.color.setHex(Y.isRunning?2278750:15680580),e.mesh.userData.powerButton.material.emissive.setHex(Y.isRunning?2278750:0),e.mesh.userData.powerButton.material.emissiveIntensity=Y.isRunning?1.5:0,e.mesh.userData.powerLed&&(e.mesh.userData.powerLed.material.color.setHex(Y.isRunning?2278750:15680580),e.mesh.userData.powerLed.material.emissive.setHex(Y.isRunning?2278750:15680580),e.mesh.userData.powerLed.material.emissiveIntensity=Y.isRunning?2.5:.4)),(e.type===`ammeter`||e.type===`voltmeter`)&&Y.isRunning){let t=e.type===`ammeter`?6333946:16281969;if(e.mesh.userData.meterGlow)e.mesh.userData.meterGlow.intensity=Y.isRunning?.8:0,e.mesh.userData.meterGlow.position.copy(e.mesh.position),e.mesh.userData.meterGlow.position.y+=.25;else{let n=new qs(t,.8,.7);n.position.copy(e.mesh.position),n.position.y+=.25,Z.add(n),e.mesh.userData.meterGlow=n}}else (e.type===`ammeter`||e.type===`voltmeter`)&&e.mesh.userData.meterGlow&&(e.mesh.userData.meterGlow.intensity=0);if(e.type===`display`){let t=Math.floor(e.snap1/14),n=e.snap1%14,r=Math.floor(e.snap2/14),i=e.snap2%14,a=Math.round((t+r)/2),o=Pp(),s=e=>o.find(e),c=e=>{let t=s(0),n=s(12),r=s(882);return e===t||e===n||e===r},l=e=>{let t=s(1),n=s(13),r=s(883);return e===t||e===n||e===r},u=s(a*14+n),d=s(a*14+i),f=Y.isRunning&&(c(u)||c(d)),p=(t,n,r)=>{let i=e.mesh.userData[r];if(!i)return;let a=s(t*14+n);f&&l(a)?(i.material.color.setHex(16724787),i.material.emissive.setHex(16711680),i.material.emissiveIntensity=8):(i.material.color.setHex(2229509),i.material.emissive.setHex(0),i.material.emissiveIntensity=0)};p(a-2,n,`seg_g`),p(a-1,n,`seg_f`),p(a+1,n,`seg_a`),p(a+2,n,`seg_b`),p(a-2,i,`seg_e`),p(a-1,i,`seg_d`),p(a+1,i,`seg_c`),p(a+2,i,`seg_dp`)}})}var Em=new vc,Dm=new z,Om=null,km=0,Am=0,jm=null,Mm=!1;function Nm(e=!1){Zp&&=(Z.remove(Zp),null),Y.placedComponents.forEach((t,n)=>{if(n===Y.selectedComponentIdx&&!e){let e=!1;if(t.mesh&&(t.mesh.traverse(t=>{t.name===`selectionOutline`&&(e=!0)}),!e)){let e=Pm(t);t.mesh.add(e)}return}if(t.mesh){let e=[];t.mesh.traverse(t=>{t.name===`selectionOutline`&&e.push(t)}),e.forEach(e=>{t.mesh.remove(e),Z.remove(e)})}})}function Pm(e){let t=new B(.6,.4,.6),n=new B(0,0,0);switch(e.type){case`resistor`:t.set(1.3,.45,.45);break;case`capacitor`:t.set(.5,1,.9);break;case`inductor`:t.set(1.5,.6,.6);break;case`led`:t.set(.24,.24,.24),n.set(0,.03,0);break;case`button`:case`toggle_switch`:t.set(.41,.22,.41),n.set(0,.04,0);break;case`source`:Y.activeExperiment===`arduino_led`?t.set(.35,.25,.45):t.set(1.1,1.3,1.1);break;case`ammeter`:case`voltmeter`:t.set(.68,.35,.46),n.set(0,.05,0);break;case`diode`:t.set(.6,.24,.24);break;case`transistor`:t.set(.35,.52,.32),n.set(0,-.02,0);break;case`display`:t.set(.82,.32,.74),n.set(0,.07,0);break}let r=new W(t.x,t.y,t.z),i=new jn;i.name=`selectionOutline`,i.position.copy(n);let a=new Qi(new ga(r),new Bi({color:16347926,transparent:!0,opacity:.9}));return i.add(a),i}function Fm(){Em.setFromCamera(Dm,Vp),Kp.position.y=-10,Om=null;let e=null;if(Y.placedComponents.length>0&&!Mm&&!Y.isDraggingComponent){let t=Y.placedComponents.map(e=>e.mesh),n=Em.intersectObjects(t,!0);if(n.length>0){let t=n[0].object;for(;t&&(e=Y.placedComponents.find(e=>e.mesh===t),!e);)t=t.parent}}if(e){if(jm!==e&&(Nm(),jm=e),Qp){let t=e.type.charAt(0).toUpperCase()+e.type.slice(1);e.type===`resistor`?t=`Resistor (${Y.params.R} Ω)`:e.type===`capacitor`?t=`Capacitor (${Y.params.C} µF)`:e.type===`inductor`?t=`Inductor (${Y.params.L} mH)`:e.type===`source`?t=`Power Source (${Y.params.V} V)`:e.type===`led`?t=`Red LED`:e.type===`button`?t=`Push Button`:e.type===`toggle_switch`?t=`ON/OFF Switch`:e.type===`diode`?t=`PN Junction Diode`:e.type===`transistor`?t=`NPN Transistor`:e.type===`display`&&(t=`7-Segment Display`),Qp.innerText=t,Qp.style.left=`${km+15}px`,Qp.style.top=`${Am-35}px`,Qp.style.display=`block`}}else jm&&(Nm(),jm=null,Qp&&(Qp.style.display=`none`));let t=!1;if(!e&&Wp&&!Mm&&!Y.isDraggingComponent&&!Y.isDraggingWireEnd&&!Y.selectedTool&&Em.intersectObject(Wp).length>0&&(t=!0),t?Gp||(Gp=new Qi(new ga(new W(tm===30?5:10,.2,3.64)),new Bi({color:16347926,transparent:!0,opacity:.85})),Gp.position.set(0,-.02,0),Z.add(Gp)):Gp&&=(Z.remove(Gp),null),(Y.selectedTool&&Y.selectedTool!==`eraser`||Y.isDraggingComponent||Y.isDraggingWireEnd||!Y.selectedTool)&&!e&&!Mm){let e=[];if(Jp&&Yp&&qp&&qp.visible&&(e=Em.intersectObjects([Jp,Yp])),e.length>0){Om=e[0].object.userData.snapIndex;let t=sm(Om);Kp.position.copy(t),Kp.position.y=t.y+.05;return}let t=Em.intersectObject(Up);if(t.length>0){let e=t[0].point,n=Up.worldToLocal(e.clone()),r=-(tm-1)*.1522/2,i=Math.round((n.x-r)/.1522);i=Math.max(0,Math.min(tm-1,i));let a=0,o=1/0;for(let e=0;e<14;e++){let t=0;e===0?t=-1.296:e===1?t=-1.144:e>=2&&e<=6?t=-.839+(e-2)*.1522:e>=7&&e<=11?t=.229+(e-7)*.1522:e===12?t=1.144:e===13&&(t=1.296);let r=Math.abs(n.z-t);r<o&&(o=r,a=e)}let s=a===0||a===1||a===12||a===13,c=i%6==5;if(s&&c)return;Om=i*14+a;let l=sm(Om);Kp.position.copy(l),Kp.position.y=.135}}}function Im(){if(!Y.selectedTool){Om===null?(Y.selectedHoleIndex=null,Y.selectedComponentIdx=-1,Nm(!0),Jm()):(Y.selectedHoleIndex=Om,Y.selectedComponentIdx=-1,Nm(!0),Jm()),Rp();return}if(Y.selectedTool!==`eraser`){if(Y.targetSnap1!==null&&Y.targetSnap2!==null){let e=Y.targetSnap1,t=Y.targetSnap2;Y.selectedTool===`wire`?Zm(e,t):Hm(Y.selectedTool,e,t),Y.placementStartHole=null,Y.selectedTool=null,document.querySelectorAll(`.comp-chip:not([data-type^="bb_"])`).forEach(e=>e.classList.remove(`selected`)),wp(),Rp();return}if(Om!==null)if(Y.placementStartHole===null)Y.placementStartHole=Om,X.aiMessage.innerText=`First socket snapped. Choose second socket.`,wp();else{let e=Y.placementStartHole,t=Om;e!==t&&(Y.selectedTool===`wire`?Zm(e,t):Hm(Y.selectedTool,e,t)),Y.placementStartHole=null,Y.selectedTool=null,document.querySelectorAll(`.comp-chip:not([data-type^="bb_"])`).forEach(e=>e.classList.remove(`selected`)),wp()}}else{Em.setFromCamera(Dm,Vp);let e=Y.placedComponents.map(e=>e.mesh),t=Em.intersectObjects(e,!0);if(t.length>0){let e=t[0].object,n=-1;for(;e&&(n=Y.placedComponents.findIndex(t=>t.mesh===e),n===-1);)e=e.parent;n!==-1&&Qm(n);return}let n=Y.wires.map(e=>e.lineMesh),r=Em.intersectObjects(n);if(r.length>0){let e=r[0].object,t=Y.wires.findIndex(t=>t.lineMesh===e);t!==-1&&$m(t)}}Rp()}function Lm(e){let t=[0,9127187,16711680,16747520,16776960,32768,255,15631086,8421504,16777215],n=e.toString(),r=parseInt(n[0])||0,i=parseInt(n[1])||0,a=n.length-2;return[t[r],t[i],a>=0&&a<10?t[a]:9127187]}function Rm(){let e=Lm(Y.params.R);Y.placedComponents.forEach(t=>{if(t.type===`resistor`&&(t.mesh.userData.bands&&t.mesh.userData.bands.forEach((t,n)=>{t.material.color.setHex(e[n])}),t.mesh.userData.gltfBands)){let[n,r]=t.mesh.userData.gltfBands;n&&n.material&&n.material.color.setHex(e[0]),r&&r.material&&r.material.color.setHex(e[2])}})}function zm(e){let t=[`object_6`,`object_14`,`object_31`,`object_35`,`object_61`,`object_68`,`object_72`,`object_41`,`object_47`,`object_51`,`object_53`,`object_26`,`object_74`],n=e;for(;n;){let e=n.name.toLowerCase();if(e.includes(`leg`)||e.includes(`lead`)||e.includes(`wire`)||t.includes(e))return!0;n=n.parent}return!1}function Bm(e,t,n=null){if(!Gf)return null;let r=Gf.getObjectByName(e);if(!r)return console.warn(`Template node not found: ${e}`),null;let i=new jn,a=r.clone(),o=new tr;a.traverse(e=>{if(e.isMesh){if(zm(e))return;o.expandByObject(e)}});let s=new B;return o.isEmpty()&&o.setFromObject(a),o.getCenter(s),a.position.sub(s),i.add(a),i.scale.set(t,t,t),i.userData.localBottomY=o.min.y-s.y,i.userData.localMinX=o.min.x-s.x,i.userData.localMaxX=o.max.x-s.x,n&&(a.rotation.x+=n.x||0,a.rotation.y+=n.y||0,a.rotation.z+=n.z||0),{wrapper:i,clone:a}}function Vm(e,t,n,r=null){e===`source`&&Y.activeExperiment===`arduino_led`&&(t=882,n=883);let i=sm(t),a=sm(n),o=new B().addVectors(i,a).multiplyScalar(.5);e===`button`||e===`toggle_switch`?o.y=.12:e===`led`||e===`transistor`||e===`inductor`?o.y=.28:e===`capacitor`?o.y=.3:e===`resistor`?o.y=.28:e===`diode`?o.y=.3:e===`ammeter`||e===`voltmeter`?o.y=.38:e===`display`?o.y=.08:o.y=.45;let s=new jn;s.position.copy(o);let c=new B().subVectors(a,i);if(e===`display`){Math.floor(t/14);let e=t%14,r=sm(Math.floor(n/14)*14+e);r.distanceTo(i)>.001?c.subVectors(r,i):c.set(1,0,0)}c.length(),c.normalize();let l=new Nt().setFromUnitVectors(new B(1,0,0),c);s.quaternion.copy(l);let u=[];if(e===`resistor`){if(Wf){let e=Wf.clone(),t=new tr().setFromObject(e),n=new B;t.getSize(n);let r=new B;t.getCenter(r),e.traverse(e=>{if(e.isMesh){e.position.sub(r);let t=Lm(Y.params.R);e.name===`LARANJA-material`?(e.material=e.material.clone(),e.material.color.setHex(t[0]),e.material.roughness=.35):e.name===`MARRON-material`?(e.material=e.material.clone(),e.material.color.setHex(t[2]),e.material.roughness=.35):e.name===`OURO-material`?(e.material=e.material.clone(),e.material.color.setHex(13938487),e.material.roughness=.1,e.material.metalness=.9):e.name===`CERAMICA-material`&&(e.material=e.material.clone(),e.material.color.setHex(14535588),e.material.roughness=.5)}}),e.scale.set(75,75,75),s.add(e),s.userData={gltfBands:[e.getObjectByName(`LARANJA-material`),e.getObjectByName(`MARRON-material`)]}}else{let e=new U(new G(.12,.12,.6,16),new K({color:14535588,roughness:.6}));e.rotation.z=Math.PI/2,e.castShadow=!0,s.add(e);let t=new G(.135,.12,.06,16),n=new K({color:14535588,roughness:.6}),r=new U(t,n);r.position.x=-.3,r.rotation.z=-Math.PI/2,s.add(r);let i=new U(t,n);i.position.x=.3,i.rotation.z=Math.PI/2,s.add(i);let a=new G(.128,.128,.05,16),o=Lm(Y.params.R),c=new U(a,new Jr({color:o[0]}));c.position.x=-.18,c.rotation.z=Math.PI/2,s.add(c);let l=new U(a,new Jr({color:o[1]}));l.position.x=-.04,l.rotation.z=Math.PI/2,s.add(l);let u=new U(a,new Jr({color:o[2]}));u.position.x=.1,u.rotation.z=Math.PI/2,s.add(u);let d=new U(a,new K({color:13938487,metalness:.8,roughness:.2}));d.position.x=.22,d.rotation.z=Math.PI/2,s.add(d),s.userData={bands:[c,l,u]}}let e=Wf?.2:.35,t=new B(-e,0,0).applyQuaternion(s.quaternion).add(o);u.push(Gm(t,i));let n=new B(e,0,0).applyQuaternion(s.quaternion).add(o);u.push(Gm(n,a))}else if(e===`capacitor`){let e=new K({map:Kf,roughness:.4,metalness:.2,side:2}),t=new G(.445*.26,.445*.26,1.4*.26,32,1,!1),n=t.attributes.uv;for(let e=0;e<n.count;e++){let t=n.getX(e),r=n.getY(e);n.setXY(e,t*.5,r*.5+.45)}let r=new U(t,e);r.castShadow=!0,r.receiveShadow=!0,s.add(r);let c=new U(new G(.43*.26,.43*.26,.1*.26,32),new K({color:2236962,roughness:.9,metalness:.1}));c.position.y=-.7*.26,c.castShadow=!0,c.receiveShadow=!0,s.add(c);let l=new U(new G(.43*.26,.43*.26,.02*.26,32),new K({color:1710618,roughness:.85,metalness:.1}));l.position.y=.702*.26,l.castShadow=!0,l.receiveShadow=!0,s.add(l);let d=new B(-.039,-.195,0).applyQuaternion(s.quaternion).add(o);u.push(Gm(d,i));let f=new B(.039,-.195,0).applyQuaternion(s.quaternion).add(o);u.push(Gm(f,a))}else if(e===`inductor`){let e=Bm(`Inductor-Radial_38`,42);if(e){let t=e.wrapper;return s.add(t),{mesh:s,leads:[]}}else{let e=new U(new G(.12,.12,.6,16),new K({color:4674921,roughness:.8}));e.rotation.z=Math.PI/2,e.castShadow=!0,s.add(e);for(let e=-.22;e<=.22;e+=.08){let t=new U(new Ro(.14,.03,8,20),new K({color:14251782,metalness:.9,roughness:.1}));t.position.x=e,t.rotation.y=Math.PI/2,s.add(t)}let t=new B(-.3,0,0).applyQuaternion(s.quaternion).add(o);u.push(Um(t,i));let n=new B(.3,0,0).applyQuaternion(s.quaternion).add(o);u.push(Um(n,a))}}else if(e===`led`){let e=r||Y.params.led_color||`red`,t=15680580;e===`green`?t=2278750:e===`yellow`?t=15381256:e===`blue`?t=3900150:e===`white`&&(t=14739711);let n=new Xo({color:t,roughness:.05,metalness:0,transmission:.75,thickness:.4,transparent:!0,opacity:.88,emissive:0,emissiveIntensity:0,side:2}),c=new K({color:13158600,metalness:.92,roughness:.1}),l=new K({color:1710618,roughness:.65,metalness:.05}),d=new U(new G(.075,.075,.12,20),n);d.position.y=.02,d.castShadow=!0,s.add(d);let f=new U(new Lo(.075,20,20,0,Math.PI*2,0,Math.PI/2),n);f.position.y=.08,f.castShadow=!0,s.add(f);let p=new U(new G(.082,.082,.018,20),l);p.position.y=-.041,s.add(p);let m=new U(new G(.006,.006,.07,8),c);m.position.set(-.022,.01,0),s.add(m);let h=new U(new G(.018,.012,.05,10),c);h.position.set(.022,.005,0),s.add(h);let g=i.distanceTo(a),_=new Ga,v=new B(-.022,.02,0).applyQuaternion(s.quaternion).add(o),y=new B(-.022,-.05,0).applyQuaternion(s.quaternion).add(o),b=new B(-g/2,-.1,0).applyQuaternion(s.quaternion).add(o),x=i.clone().add(new B(0,-.08,0));_.add(new Ba(v,y)),_.add(new Ba(y,b)),_.add(new Ba(b,x));let S=new U(new zo(_,16,.007,8,!1),c);S.castShadow=!0,S.receiveShadow=!0,u.push(S);let C=new Ga,w=new B(.022,.02,0).applyQuaternion(s.quaternion).add(o),T=new B(.022,-.05,0).applyQuaternion(s.quaternion).add(o),E=new B(g/2,-.1,0).applyQuaternion(s.quaternion).add(o),D=a.clone().add(new B(0,-.08,0));C.add(new Ba(w,T)),C.add(new Ba(T,E)),C.add(new Ba(E,D));let O=new U(new zo(C,16,.007,8,!1),c);O.castShadow=!0,O.receiveShadow=!0,u.push(O),s.userData={ledMat:n}}else if(e===`button`||e===`toggle_switch`){let t=new K({color:1381653,roughness:.5,metalness:.1}),n=new K({color:13751771,roughness:.2,metalness:.9,side:2}),r=new U(new W(.28,.16,.28),t);r.position.y=.08,r.castShadow=!0,r.receiveShadow=!0,s.add(r);let i=new U(new W(.29,.015,.29),n);i.position.y=.1675,i.castShadow=!0,s.add(i);let a=new G(.015,.015,.004,12),o=new K({color:1579035,roughness:.6}),c=[-.0975,.0975];c.forEach(e=>{c.forEach(t=>{let n=new U(a,o);n.position.set(e,.175,t),n.castShadow=!0,s.add(n)})});let l=new U(new G(.07,.07,.06,24),new K({color:e===`button`?14427686:1118481,roughness:e===`button`?.4:.6,metalness:.1}));l.name=`plunger`,l.userData.originalY=.2075,l.position.y=Y.buttonPressed?.1675:.2075,l.castShadow=!0,s.add(l);let u=[-.2296,.2296],d=[-.1522,.1522];return u.forEach(e=>{d.forEach(t=>{let r=new U(new W(.12,.02,.04),n);r.position.set(e>0?.17:-.17,.02,t),r.castShadow=!0,s.add(r);let i=new U(new W(.02,.15,.02),n);i.position.set(e,-.055,t),i.castShadow=!0,s.add(i)})}),{mesh:s,leads:[]}}else if(e===`source`){if(Y.activeExperiment===`arduino_led`){let e=new B(-1.1,.23,-.6);qp.updateMatrixWorld(!0),e.applyMatrix4(qp.matrixWorld);let t=new B(-4,1.5,-6),n=new B().addVectors(e,t).multiplyScalar(.5);n.y+=.8;let r=new U(new zo(new Ea([e,n,t]),24,.06,8,!1),new K({color:1120295,roughness:.6})),i=new U(new W(.2,.15,.35),new K({color:13751771,metalness:.9}));i.position.copy(e),i.lookAt(t);let a=new jn;return a.add(r),a.add(i),{mesh:a,leads:[]}}let e=new U(um(.9,.38,.6,.05),new K({color:1120295,roughness:.8}));e.position.y=-.01,e.castShadow=!0,e.receiveShadow=!0,s.add(e);let t=new U(um(.86,.39,.56,.04),new K({color:2565930,roughness:.4,metalness:.3}));t.position.y=.005,t.castShadow=!0,t.receiveShadow=!0,s.add(t);let n=new U(um(.88,.03,.58,.04),new K({color:15381256,roughness:.2,metalness:.8}));n.position.y=.18,s.add(n);let r=new U(new Fo(.64,.39),new K({color:988970,roughness:.7}));r.rotation.x=-Math.PI/2,r.position.set(0,.2005,-.05),s.add(r);let c=new Fo(.6,.35),l=new U(c,new Jr({map:_m}));l.rotation.x=-Math.PI/2,l.position.set(0,.201,-.05),s.add(l);let d=new U(c,new K({color:16777215,transparent:!0,opacity:.15,roughness:.05,metalness:.9}));d.rotation.x=-Math.PI/2,d.position.set(0,.202,-.05),s.add(d);let f=fm(15680580);f.position.set(-.35,.2,.18),s.add(f);let p=fm(1976635);p.position.set(.35,.2,.18),s.add(p);let m=new U(new G(.05,.05,.04,16),new K({color:4144966,roughness:.5,metalness:.5}));m.position.set(.24,.21,-.05),s.add(m);let h=new U(new W(.015,.045,.015),new Jr({color:15680580}));h.position.set(.24,.23,-.07),s.add(h);let g=new U(new G(.05,.05,.03,12),new K({color:Y.isRunning?2278750:15680580,emissive:Y.isRunning?2278750:0,emissiveIntensity:Y.isRunning?1.5:0,roughness:.2}));g.position.set(-.15,.21,.18),s.add(g);let _=new U(new Lo(.02,8,8),new K({color:Y.isRunning?2278750:15680580,emissive:Y.isRunning?2278750:15680580,emissiveIntensity:Y.isRunning?2.5:.4}));_.position.set(.05,.21,.18),s.add(_);let v=new U(new W(.18,.1,.15),new K({color:13751771,metalness:.9,roughness:.1}));v.position.set(-.46,.05,-.1),v.rotation.y=Math.PI/2,s.add(v),s.userData={powerButton:g,powerLed:_};let y=new B(-.35,.3,.18).applyQuaternion(s.quaternion).add(o);u.push(Um(y,i));let b=new B(.35,.3,.18).applyQuaternion(s.quaternion).add(o);u.push(Um(b,a))}else if(e===`ammeter`||e===`voltmeter`){let t=e===`ammeter`,n=t?1920728:12131356,r=new U(um(.55,.38,.22,.04),new K({color:1976635,roughness:.75,metalness:.15}));r.castShadow=!0,r.receiveShadow=!0,s.add(r);let c=new U(um(.52,.36,.08,.03),new K({color:n,roughness:.4,metalness:.3}));c.position.z=.07,s.add(c);let l=new U(new W(.44,.22,.02),new K({color:330260,roughness:.8}));l.position.set(0,.06,.12),s.add(l);let d=new Fo(.4,.19),f=new U(d,new Jr({map:t?Sm:bm,side:0}));f.position.set(0,.06,.131),s.add(f);let p=new U(d,new K({color:11197951,transparent:!0,opacity:.08,roughness:.02,metalness:.6}));p.position.set(0,.06,.132),s.add(p);let m=new U(new W(.35,.04,.01),new K({color:988970,roughness:.9}));m.position.set(0,-.07,.131),s.add(m);let h=fm(15680580);h.position.set(-.17,-.14,.05),h.scale.set(.6,.6,.6),h.rotation.x=Math.PI/2,s.add(h);let g=fm(1976635);g.position.set(.17,-.14,.05),g.scale.set(.6,.6,.6),g.rotation.x=Math.PI/2,s.add(g);let _=new U(new G(.045,.045,.04,16),new K({color:4144966,roughness:.4,metalness:.6}));_.rotation.x=Math.PI/2,_.position.set(.2,-.1,.13),s.add(_);let v=new B(-.17,-.22,0).applyQuaternion(s.quaternion).add(o);u.push(Gm(v,i));let y=new B(.17,-.22,0).applyQuaternion(s.quaternion).add(o);u.push(Gm(y,a))}else if(e===`diode`){let e=new U(new G(.065,.065,.38,32),new K({color:1184274,roughness:.65,metalness:.1}));e.rotation.z=Math.PI/2,e.castShadow=!0,e.receiveShadow=!0,s.add(e);let t=new U(new G(.067,.067,.08,32),new K({color:14540253,metalness:.85,roughness:.2}));t.position.x=.12,t.rotation.z=Math.PI/2,t.castShadow=!0,s.add(t);let n=new B(-.19,0,0).applyQuaternion(s.quaternion).add(o);u.push(Gm(n,i));let r=new B(.19,0,0).applyQuaternion(s.quaternion).add(o);u.push(Gm(r,a))}else if(e===`transistor`){let e=new K({color:1579035,roughness:.55,metalness:.1}),r=new K({color:14540253,metalness:.95,roughness:.08}),c=new U(new G(.135,.135,.24,16,1,!1,0,Math.PI),e);c.position.set(0,.12,0),c.castShadow=!0,c.receiveShadow=!0,s.add(c);let l=new U(new W(.27,.24,.01),e);l.position.set(0,.12,-.005),l.castShadow=!0,l.receiveShadow=!0,s.add(l);let d=.011,f=Math.floor(t/14),p=t%14,m=Math.floor(n/14),h=n%14,g=Math.round((f+m)/2),_=Math.round((p+h)/2),v=sm(g*14+_),y=new Ga,b=new B(-.076,0,0).applyQuaternion(s.quaternion).add(o),x=new B(-.076,-.05,0).applyQuaternion(s.quaternion).add(o),S=new B(-.1522,-.08,0).applyQuaternion(s.quaternion).add(o),C=i.clone().add(new B(0,-.08,0));y.add(new Ba(b,x)),y.add(new Ba(x,S)),y.add(new Ba(S,C));let w=new U(new zo(y,16,d,8,!1),r);w.castShadow=!0,w.receiveShadow=!0,u.push(w);let T=new Ga,E=new B(0,0,0).applyQuaternion(s.quaternion).add(o),D=new B(0,-.05,0).applyQuaternion(s.quaternion).add(o),O=v.clone().add(new B(0,-.08,0));T.add(new Ba(E,D)),T.add(new Ba(D,O));let ee=new U(new zo(T,12,d,8,!1),r);ee.castShadow=!0,ee.receiveShadow=!0,u.push(ee);let k=new Ga,te=new B(.076,0,0).applyQuaternion(s.quaternion).add(o),ne=new B(.076,-.05,0).applyQuaternion(s.quaternion).add(o),A=new B(.1522,-.08,0).applyQuaternion(s.quaternion).add(o),re=a.clone().add(new B(0,-.08,0));k.add(new Ba(te,ne)),k.add(new Ba(ne,A)),k.add(new Ba(A,re));let ie=new U(new zo(k,16,d,8,!1),r);return ie.castShadow=!0,ie.receiveShadow=!0,u.push(ie),{mesh:s,leads:u}}else if(e===`display`){let e=.1522,r=new U(new W(5*e,.22,.72),new K({color:988970,roughness:.7}));r.castShadow=!0,r.receiveShadow=!0,r.position.y=.11,s.add(r);let i=new U(new W(5*e-.04,.01,.68),new K({color:527380,roughness:.8}));i.position.set(0,.22,0),i.castShadow=!0,s.add(i);let a=(e,t,n,r,i=0,a)=>{let o=new K({color:2032901,emissive:0,emissiveIntensity:0,roughness:.4}),c=new U(new W(n,.02,r),o);c.position.set(e,.226,t),c.rotation.y=i,c.castShadow=!0,s.add(c),s.userData[a]=c};a(0,-.18,.18,.036,0,`seg_a`),a(.096,-.09,.036,.18,0,`seg_b`),a(.096,.09,.036,.18,0,`seg_c`),a(0,.18,.18,.036,0,`seg_d`),a(-.096,.09,.036,.18,0,`seg_e`),a(-.096,-.09,.036,.18,0,`seg_f`),a(0,0,.18,.036,0,`seg_g`);let o=new K({color:2032901,emissive:0,emissiveIntensity:0,roughness:.4}),c=new U(new Lo(.024,8,8),o);c.position.set(.18,.226,.18),c.castShadow=!0,s.add(c),s.userData.seg_dp=c;let l=Math.floor(t/14),d=t%14,f=Math.floor(n/14),p=n%14,m=Math.round((l+f)/2);for(let e=-2;e<=2;e++){let t=m+e,n=sm(t*14+d),r=Wm(n,n.clone().add(new B(0,-.08,0)),.012);r.castShadow=!0,r.receiveShadow=!0,u.push(r);let i=sm(t*14+p),a=Wm(i,i.clone().add(new B(0,-.08,0)),.012);a.castShadow=!0,a.receiveShadow=!0,u.push(a)}}return{mesh:s,leads:u}}function Hm(e,t,n){e===`source`&&Y.activeExperiment===`arduino_led`&&(t=882,n=883);let r=e===`led`?Y.params.led_color||`red`:null,{mesh:i,leads:a}=Vm(e,t,n,r);if(Z.add(i),a.forEach(e=>Z.add(e)),Y.placedComponents.push({type:e,id:Y.placedComponents.length,snap1:t,snap2:n,mesh:i,leads:a,color:e===`led`?r:void 0}),Y.activeExperiment===`ohms`)e===`resistor`&&_p(1),e===`source`&&_p(2),(e===`ammeter`||e===`voltmeter`)&&_p(3);else if(Y.activeExperiment===`lcr`)e===`resistor`&&_p(1);else if(Y.activeExperiment===`arduino_led`){e===`source`&&_p(1);let t=Y.placedComponents.some(e=>e.type===`button`||e.type===`toggle_switch`)||e===`button`||e===`toggle_switch`,n=Y.placedComponents.some(e=>e.type===`led`)||e===`led`;t&&n&&_p(2),e===`resistor`&&_p(3)}vp(),Tm(),Bp(),Rp(),$f().status===`success`&&wm(),nh()}function Um(e,t){let n=new B().addVectors(e,t).multiplyScalar(.5);return n.y=Math.max(e.y,t.y)+.12,new U(new zo(new Ea([e,n,t]),12,.022,6,!1),new K({color:13358561,metalness:.9,roughness:.1}))}function Wm(e,t,n=.012){return new U(new zo(new Ba(e,t),4,n,6,!1),new K({color:13158600,metalness:.95,roughness:.08}))}function Gm(e,t){let n=new B(t.x,e.y,t.z),r=new B().subVectors(n,e),i=r.length();if(i<.005)return new U(new zo(new Ba(e,t),8,.022,6,!1),new K({color:14540253,metalness:.95,roughness:.08}));r.normalize();let a=Math.min(.06,i*.4),o=new B().addScaledVector(r,-a).add(n),s=new B(n.x,n.y-a,n.z),c=new Ga;return c.add(new Ba(e,o)),c.add(new Ha(o,n,s)),c.add(new Ba(s,t)),new U(new zo(c,24,.022,6,!1),new K({color:14540253,metalness:.95,roughness:.08}))}function Km(){let e=new Set;return Y.placedComponents.forEach(t=>{t.type===`source`&&Y.activeExperiment===`arduino_led`||(e.add(t.snap1),e.add(t.snap2))}),e}function qm(e,t,n=null){if(e===882||e===883||!t.has(e))return e;let r=Math.floor(e/14),i=e%14;if(i>=2&&i<=6){let e=[2,3,4,5,6];e.sort((e,t)=>{let n=e-i,r=t-i;return n>0&&r<=0?-1:r>0&&n<=0?1:Math.abs(n)-Math.abs(r)});for(let i of e){let e=r*14+i;if(!t.has(e)&&e!==n)return e}}else if(i>=7&&i<=11){let e=[7,8,9,10,11];e.sort((e,t)=>{let n=e-i,r=t-i;return n>0&&r<=0?-1:r>0&&n<=0?1:Math.abs(n)-Math.abs(r)});for(let i of e){let e=r*14+i;if(!t.has(e)&&e!==n)return e}}else{let e=[];for(let t=1;t<12;t++)e.push(r+t,r-t);for(let r of e)if(r>=0&&r<tm){if(r%6==5)continue;let e=r*14+i;if(!t.has(e)&&e!==n)return e}}return e}function Jm(){let e=document.getElementById(`sel-comp-info`);if(e)if(Y.selectedComponentIdx!==-1&&Y.selectedComponentIdx!==void 0){let t=Y.placedComponents[Y.selectedComponentIdx];if(!t){e.innerHTML=`Click a hole or component to inspect.`;return}let n=t.type.charAt(0).toUpperCase()+t.type.slice(1),r=``,i=e=>e===882?`Arduino 5V`:e===883?`Arduino GND`:`Col ${Math.floor(e/14)+1}, Row ${[`+`,`-`,`A`,`B`,`C`,`D`,`E`,`F`,`G`,`H`,`I`,`J`,`+`,`-`][e%14]}`;if(t.type===`resistor`)n=`Ceramic Resistor`,r=`
    ...
    `,i.addEventListener(`click`,()=>{pp(e),document.getElementById(`modal-library`).style.display=`none`}),r.appendChild(i)}),t.appendChild(r)}var th=null;function nh(){Y.isDatabaseLoading||(X.saveDot&&X.saveText&&(X.saveText.innerText=`DB: SYNCING...`,X.saveDot.style.background=`#eab308`),th&&clearTimeout(th),th=setTimeout(()=>{rh()},1500))}async function rh(){if(!Y.isDatabaseLoading)try{let e={user_id:`a1b2c3d4-e5f6-7890-abcd-ef1234567890`,experiment_type:Y.activeExperiment,name:`Experiment: ${Y.activeExperiment}`,description:`Saved breadboard layout for ${Y.activeExperiment}`,circuit_data:{placedComponents:Y.placedComponents.map(e=>({type:e.type,snap1:e.snap1,snap2:e.snap2})),wires:Y.wires.map(e=>({fromHole:e.fromHole,toHole:e.toHole}))},params:Y.params},t=await fetch(`/api/db/save-circuit`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)});if(t.ok)await t.json(),X.saveDot&&X.saveText&&(X.saveText.innerText=`DB: SAVED`,X.saveDot.style.background=`#10b981`);else throw Error(`HTTP ${t.status}`)}catch(e){console.error(`[DB Error] Failed to auto-save circuit diagram:`,e),X.saveDot&&X.saveText&&(X.saveText.innerText=`DB: OFFLINE`,X.saveDot.style.background=`#f43f5e`)}}async function ih(e){Y.isDatabaseLoading=!0,X.saveDot&&X.saveText&&(X.saveText.innerText=`DB: LOADING...`,X.saveDot.style.background=`#3b82f6`);try{let t=await fetch(`/api/db/load-circuit?experiment_type=${e}&user_id=a1b2c3d4-e5f6-7890-abcd-ef1234567890`);if(!t.ok){X.saveDot&&X.saveText&&(X.saveText.innerText=`DB: EMPTY`,X.saveDot.style.background=`#64748b`);return}let n=await t.json();if(n.status===`success`&&n.circuit&&n.circuit.circuit_data){let e=n.circuit.circuit_data;e.placedComponents&&e.placedComponents.length>0&&e.placedComponents.forEach(e=>{Hm(e.type,e.snap1,e.snap2)}),e.wires&&e.wires.length>0&&e.wires.forEach(e=>{Zm(e.fromHole,e.toHole)}),e.params&&Object.keys(e.params).forEach(t=>{sp(t,e.params[t])}),X.saveDot&&X.saveText&&(X.saveText.innerText=`DB: LOADED`,X.saveDot.style.background=`#10b981`),op(`Circuit IQ · AI Mentor`,`Loaded your previously saved circuit layout from database.`)}else X.saveDot&&X.saveText&&(X.saveText.innerText=`DB: READY`,X.saveDot.style.background=`var(--accent)`)}catch(e){console.error(`[DB Error] Failed to load circuit diagram:`,e),X.saveDot&&X.saveText&&(X.saveText.innerText=`DB: OFFLINE`,X.saveDot.style.background=`#f43f5e`)}finally{Y.isDatabaseLoading=!1}}async function ah(e=``,t=null){try{let n=Math.round((Date.now()-Y.energyStartTime)/1e3),r=t===null?Y.dataPoints.length>=5?100:Y.dataPoints.length*20:t,i={user_id:`a1b2c3d4-e5f6-7890-abcd-ef1234567890`,experiment_type:Y.activeExperiment,results:{volts:Y.meters.volts,amps:Y.meters.amps,ohms:Y.meters.ohms,power:Y.meters.power,energy:Y.meters.energy,dataPointsCount:Y.dataPoints.length},duration_seconds:n||60,score:r,notes:e||X.conclusionText.innerText||`Experiment performed.`,feedback:`Student successfully compiled data points and downloaded experiment logs.`};await fetch(`/api/db/save-log`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(i)}),console.log(`[DB] Logged experiment run successfully.`)}catch(e){console.error(`[DB Error] Failed to log experiment completion:`,e)}}function oh(){Qp=document.createElement(`div`),Qp.className=`component-tooltip`,document.body.appendChild(Qp),ip(),Ap(),pp(new URLSearchParams(window.location.search).get(`exp`)||`ohms`,!1),yp(),setTimeout(()=>{hm()},100);let e=document.getElementById(`modal-library`),t=document.getElementById(`library-close`);X.experimentSelect&&X.experimentSelect.addEventListener(`mousedown`,t=>{if(t.preventDefault(),e){e.style.display=`flex`,eh(`circuits`),document.querySelectorAll(`.lib-tab-btn`).forEach(e=>{e.style.background=`none`,e.style.color=`#64748b`});let t=document.querySelector(`.lib-tab-btn[data-lib-cat="circuits"]`);t&&(t.style.background=`rgba(59,130,246,0.12)`,t.style.color=`#60a5fa`)}}),t&&t.addEventListener(`click`,()=>{e&&(e.style.display=`none`)}),document.querySelectorAll(`.lib-tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`.lib-tab-btn`).forEach(e=>{e.style.background=`none`,e.style.color=`#64748b`}),e.style.background=`rgba(59,130,246,0.12)`,e.style.color=`#60a5fa`,eh(e.getAttribute(`data-lib-cat`))})})}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,oh):oh();